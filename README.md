...
```terminal
go get go.mongodb.org/atlas-sdk/v20250312026
```
...
```go
import "go.mongodb.org/atlas-sdk/v20250312026/admin"
...
```go
import "go.mongodb.org/atlas-sdk/v20250312026/detectaiagent"
