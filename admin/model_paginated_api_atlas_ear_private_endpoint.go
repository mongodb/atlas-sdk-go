...
func (o PaginatedApiAtlasEARPrivateEndpoint) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o PaginatedApiAtlasEARPrivateEndpoint) ToMap() (map[string]interface{}, error) {
