...
// PaginatedServiceAccountGroup List of Service Account projects.
...
func (o PaginatedServiceAccountGroup) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o PaginatedServiceAccountGroup) ToMap() (map[string]interface{}, error) {
