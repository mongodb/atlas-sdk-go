...
type EncryptionAtRestUsingCustomerKeyManagementApi interface {
	...
	/*
		...
		[experimental] Creates a private endpoint in the specified region for encryption at rest using customer key management.
	...
	*/
	...
	/*
		...
		[experimental] Returns one private endpoint, identified by its ID, for encryption at rest using Customer Key Management.
	...
	*/
	...
	/*
		...
		[experimental] Returns the private endpoints of the specified cloud provider for encryption at rest using customer key management.
	...
	*/
	...
	/*
		...
		[experimental] Deletes one private endpoint, identified by its ID, for encryption at rest using Customer Key Management.
