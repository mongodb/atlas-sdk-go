...
type EncryptionAtRestUsingCustomerKeyManagementApi interface {
	...
	*/
	...
	/*
		RequestEncryptionAtRestPrivateEndpointDeletion Delete Private Endpoint for Encryption at Rest Using Customer Key Management
		...
		@param encryptionAtRestPrivateEndpointRequest Cloud provider of the private endpoints to delete and the list of cloud provider regions in which to delete the private endpoints.
		@return RequestEncryptionAtRestPrivateEndpointDeletionApiRequest
	*/
	RequestEncryptionAtRestPrivateEndpointDeletion(ctx context.Context, groupId string, cloudProvider string, endpointId string, encryptionAtRestPrivateEndpointRequest *EncryptionAtRestPrivateEndpointRequest) RequestEncryptionAtRestPrivateEndpointDeletionApiRequest
	/*
		RequestEncryptionAtRestPrivateEndpointDeletion Delete Private Endpoint for Encryption at Rest Using Customer Key Management
...
type RequestEncryptionAtRestPrivateEndpointDeletionApiRequest struct {
	...
	cloudProvider                          string
	endpointId                             string
	encryptionAtRestPrivateEndpointRequest *EncryptionAtRestPrivateEndpointRequest
}
...
func (a *EncryptionAtRestUsingCustomerKeyManagementApiService) RequestEncryptionAtRestPrivateEndpointDeletionWithParams(ctx context.Context, args *RequestEncryptionAtRestPrivateEndpointDeletionApiParams) RequestEncryptionAtRestPrivateEndpointDeletionApiRequest {
	return RequestEncryptionAtRestPrivateEndpointDeletionApiRequest{
		...
		cloudProvider:                          args.CloudProvider,
		endpointId:                             args.EndpointId,
		encryptionAtRestPrivateEndpointRequest: args.EncryptionAtRestPrivateEndpointRequest,
	}
}
...
Deletes one private endpoint, identified by its ID, for encryption at rest using Customer Key Management.
	...
	@return RequestEncryptionAtRestPrivateEndpointDeletionApiRequest
*/
func (a *EncryptionAtRestUsingCustomerKeyManagementApiService) RequestEncryptionAtRestPrivateEndpointDeletion(ctx context.Context, groupId string, cloudProvider string, endpointId string, encryptionAtRestPrivateEndpointRequest *EncryptionAtRestPrivateEndpointRequest) RequestEncryptionAtRestPrivateEndpointDeletionApiRequest {
	return RequestEncryptionAtRestPrivateEndpointDeletionApiRequest{
		ApiService:                             a,
		ctx:                                    ctx,
		groupId:                                groupId,
...
func (a *EncryptionAtRestUsingCustomerKeyManagementApiService) RequestEncryptionAtRestPrivateEndpointDeletionExecute(r RequestEncryptionAtRestPrivateEndpointDeletionApiRequest) (interface{}, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.encryptionAtRestPrivateEndpointRequest == nil {
		return localVarReturnValue, nil, reportError("encryptionAtRestPrivateEndpointRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.encryptionAtRestPrivateEndpointRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
