...
type PerformanceAdvisorSlowQueryMetrics struct {
	...
	// Read only field.
	HasAutoEmbedding *bool `json:"hasAutoEmbedding,omitempty"`
...
// GetHasAutoEmbedding returns the HasAutoEmbedding field value if set, zero value otherwise
func (o *PerformanceAdvisorSlowQueryMetrics) GetHasAutoEmbedding() bool {
	if o == nil || IsNil(o.HasAutoEmbedding) {
		var ret bool
		return ret
	}
	return *o.HasAutoEmbedding
}

// GetHasAutoEmbeddingOk returns a tuple with the HasAutoEmbedding field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PerformanceAdvisorSlowQueryMetrics) GetHasAutoEmbeddingOk() (*bool, bool) {
	...
	return o.HasAutoEmbedding, true
}
...
// SetHasAutoEmbedding gets a reference to the given bool and assigns it to the HasAutoEmbedding field.
func (o *PerformanceAdvisorSlowQueryMetrics) SetHasAutoEmbedding(v bool) {
	o.HasAutoEmbedding = &v
	o.NullFields = removeNullField(o.NullFields, "HasAutoEmbedding")
}

// SetHasAutoEmbeddingNil sets HasAutoEmbedding to an explicit JSON null when marshaled.
func (o *PerformanceAdvisorSlowQueryMetrics) SetHasAutoEmbeddingNil() {
	o.HasAutoEmbedding = nil
	o.NullFields = addNullField(o.NullFields, "HasAutoEmbedding")
}
...
// GetHasRerank returns the HasRerank field value if set, zero value otherwise
func (o *PerformanceAdvisorSlowQueryMetrics) GetHasRerank() bool {
	if o == nil || IsNil(o.HasRerank) {
		var ret bool
		return ret
	}
	return *o.HasRerank
...
// GetHasRerankOk returns a tuple with the HasRerank field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetHasRerank gets a reference to the given bool and assigns it to the HasRerank field.
func (o *PerformanceAdvisorSlowQueryMetrics) SetHasRerank(v bool) {
	o.HasRerank = &v
	o.NullFields = removeNullField(o.NullFields, "HasRerank")
}

// SetHasRerankNil sets HasRerank to an explicit JSON null when marshaled.
func (o *PerformanceAdvisorSlowQueryMetrics) SetHasRerankNil() {
	o.HasRerank = nil
	o.NullFields = addNullField(o.NullFields, "HasRerank")
}
...
// SetTokensUsed gets a reference to the given int64 and assigns it to the TokensUsed field.
func (o *PerformanceAdvisorSlowQueryMetrics) SetTokensUsed(v int64) {
	o.TokensUsed = &v
	o.NullFields = removeNullField(o.NullFields, "TokensUsed")
}

// SetTokensUsedNil sets TokensUsed to an explicit JSON null when marshaled.
func (o *PerformanceAdvisorSlowQueryMetrics) SetTokensUsedNil() {
	o.TokensUsed = nil
	o.NullFields = addNullField(o.NullFields, "TokensUsed")
}
