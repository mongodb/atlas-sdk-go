...
func (o *SandboxConfigUpdateRequest) MarshalJSON() ([]byte, error) {
	type noMethod SandboxConfigUpdateRequest
...
func (o *SandboxConfigUpdateRequest) SetClusterTemplateNil() {
...
func (o *SandboxConfigUpdateRequest) SetEnabledNil() {
	o.Enabled = nil
