...
func (o *StreamsTransitGatewayInvitationsResponse) MarshalJSON() ([]byte, error) {
	type noMethod StreamsTransitGatewayInvitationsResponse
...
func (o *StreamsTransitGatewayInvitationsResponse) SetLinksNil() {
	o.Links = nil
...
func (o *StreamsTransitGatewayInvitationsResponse) SetTgwIdNil() {
	o.TgwId = nil
...
func (o *StreamsTransitGatewayInvitationsResponse) SetTgwResourceShareArnNil() {
...
func (o *StreamsTransitGatewayInvitationsResponse) SetTgwResourceShareInvitationArnNil() {
