...
func (o *StreamsTransitGatewayResourceShare) MarshalJSON() ([]byte, error) {
	type noMethod StreamsTransitGatewayResourceShare
...
func (o *StreamsTransitGatewayResourceShare) SetCloudProviderNil() {
	o.CloudProvider = nil
...
func (o *StreamsTransitGatewayResourceShare) SetLinksNil() {
	o.Links = nil
...
func (o *StreamsTransitGatewayResourceShare) SetRegionNameNil() {
	o.RegionName = nil
...
func (o *StreamsTransitGatewayResourceShare) SetTgwIdNil() {
	o.TgwId = nil
...
func (o *StreamsTransitGatewayResourceShare) SetTgwResourceShareArn(v string) {
	...
	o.NullFields = removeNullField(o.NullFields, "TgwResourceShareArn")
}

// SetTgwResourceShareArnNil sets TgwResourceShareArn to an explicit JSON null when marshaled.
func (o *StreamsTransitGatewayResourceShare) SetTgwResourceShareArnNil() {
	o.TgwResourceShareArn = nil
	o.NullFields = addNullField(o.NullFields, "TgwResourceShareArn")
}
...
func (o *StreamsTransitGatewayResourceShare) SetTgwResourceShareInvitationArn(v string) {
	...
	o.NullFields = removeNullField(o.NullFields, "TgwResourceShareInvitationArn")
}

// SetTgwResourceShareInvitationArnNil sets TgwResourceShareInvitationArn to an explicit JSON null when marshaled.
func (o *StreamsTransitGatewayResourceShare) SetTgwResourceShareInvitationArnNil() {
	o.TgwResourceShareInvitationArn = nil
	o.NullFields = addNullField(o.NullFields, "TgwResourceShareInvitationArn")
}
