...
func (o StreamsAWSConnectionConfig) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o StreamsAWSConnectionConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RoleArn) {
		toSerialize["roleArn"] = o.RoleArn
	}
	if !IsNil(o.TestBucket) {
		toSerialize["testBucket"] = o.TestBucket
	}
