...
func (o *BaseSearchIndexResponseLatestDefinition) GetFields() []map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *BaseSearchIndexResponseLatestDefinition) GetFieldsOk() (*[]map[string]interface{}, bool) {
	if o == nil || IsNil(o.Fields) {
		return nil, false
	}
...
func (o *BaseSearchIndexResponseLatestDefinition) SetFields(v []map[string]interface{}) {
	o.Fields = &v
}
