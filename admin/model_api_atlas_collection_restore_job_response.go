...
type ApiAtlasCollectionRestoreJobResponse struct {
	...
	IndexStatus *ApiAtlasCollectionRestoreJobIndexStatus `json:"indexStatus,omitempty"`
...
func (o *ApiAtlasCollectionRestoreJobResponse) GetIndexStatus() ApiAtlasCollectionRestoreJobIndexStatus {
	if o == nil || IsNil(o.IndexStatus) {
		var ret ApiAtlasCollectionRestoreJobIndexStatus
		return ret
	}
...
func (o *ApiAtlasCollectionRestoreJobResponse) GetWriteStrategy() string {
	if o == nil || IsNil(o.WriteStrategy) {
		var ret string
		return ret
	}
...
// GetWriteStrategyOk returns a tuple with the WriteStrategy field value if set, nil otherwise
// and a boolean to check if the value has been set.
