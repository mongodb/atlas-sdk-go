...
type DiskBackupSnapshot struct {
	...
	// Human-readable phrase or sentence that explains the purpose of the snapshot. The resource returns this parameter when `\"status\": \"onDemand\"`.  Alternatively: Human-readable phrase or sentence that explains the purpose of the snapshot. The resource returns this parameter when `\"status\": \"onDemand\"`.  Alternatively: Human-readable phrase or sentence that explains the purpose of the snapshot. The resource returns this parameter when `\"status\": \"onDemand\"`.
	...
	// Human-readable label that identifies how often this snapshot triggers.  Alternatively: Human-readable label that identifies how often this snapshot triggers.  Alternatively: Human-readable label that identifies how often this snapshot triggers.
	FrequencyType *string `json:"frequencyType,omitempty"`
	// Unique 24-hexadecimal digit string that identifies the snapshot.  Alternatively: Unique 24-hexadecimal digit string that identifies the snapshot.  Alternatively: Unique 24-hexadecimal digit string that identifies the snapshot.
	...
	// Unique string that identifies the Amazon Web Services (AWS) Key Management Service (KMS) Customer Master Key (CMK) used to encrypt the snapshot. The resource returns this value when `\"encryptionEnabled\" : true`.  Alternatively: Unique string that identifies the Amazon Web Services (AWS) Key Management Service (KMS) Customer Master Key (CMK) used to encrypt the snapshot. The resource returns this value when `\"encryptionEnabled\" : true`.  Alternatively: Unique string that identifies the Amazon Web Services (AWS) Key Management Service (KMS) Customer Master Key (CMK) used to encrypt the snapshot. The resource returns this value when `\"encryptionEnabled\" : true`.
	MasterKeyUUID *string `json:"masterKeyUUID,omitempty"`
	// Version of the MongoDB host that this snapshot backs up.  Alternatively: Version of the MongoDB host that this snapshot backs up.  Alternatively: Version of the MongoDB host that this snapshot backs up.
	MongodVersion *string `json:"mongodVersion,omitempty"`
	// List that contains unique identifiers for the policy items.  Alternatively: List that contains unique identifiers for the policy items.  Alternatively: List that contains unique identifiers for the policy items.
	PolicyItems []string `json:"policyItems,omitempty"`
	// Human-readable label that identifies when this snapshot triggers.  Alternatively: Human-readable label that identifies when this snapshot triggers.  Alternatively: Human-readable label that identifies when this snapshot triggers.
	SnapshotType *string `json:"snapshotType,omitempty"`
	// Human-readable label that indicates the stage of the backup process for this snapshot.  Alternatively: Human-readable label that indicates the stage of the backup process for this snapshot.  Alternatively: Human-readable label that indicates the stage of the backup process for this snapshot.
	Status *string `json:"status,omitempty"`
	// Number of bytes taken to store the backup snapshot.  Alternatively: Number of bytes taken to store the backup snapshot.  Alternatively: Number of bytes taken to store the backup snapshot.
	StorageSizeBytes *int64 `json:"storageSizeBytes,omitempty"`
	// Human-readable label that categorizes the cluster as a replica set or sharded cluster.  Alternatively: Human-readable label that categorizes the cluster as a replica set or sharded cluster.  Alternatively: Human-readable label that categorizes the cluster as a replica set or sharded cluster.
