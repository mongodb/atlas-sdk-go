...
func (o *ApiStandbyLinkFailoverResponse) MarshalJSON() ([]byte, error) {
	type noMethod ApiStandbyLinkFailoverResponse
...
func (o *ApiStandbyLinkFailoverResponse) SetCompletedAt(v time.Time) {
	o.CompletedAt = &v
	o.NullFields = removeNullField(o.NullFields, "CompletedAt")
}

// SetCompletedAtNil sets CompletedAt to an explicit JSON null when marshaled.
func (o *ApiStandbyLinkFailoverResponse) SetCompletedAtNil() {
	o.CompletedAt = nil
	o.NullFields = addNullField(o.NullFields, "CompletedAt")
}
...
func (o *ApiStandbyLinkFailoverResponse) SetCreatedDateNil() {
	o.CreatedDate = nil
...
func (o *ApiStandbyLinkFailoverResponse) SetFailoverId(v string) {
	o.FailoverId = &v
	o.NullFields = removeNullField(o.NullFields, "FailoverId")
}

// SetFailoverIdNil sets FailoverId to an explicit JSON null when marshaled.
func (o *ApiStandbyLinkFailoverResponse) SetFailoverIdNil() {
	o.FailoverId = nil
	o.NullFields = addNullField(o.NullFields, "FailoverId")
}
...
func (o *ApiStandbyLinkFailoverResponse) SetFailoverStage(v string) {
	o.FailoverStage = &v
	o.NullFields = removeNullField(o.NullFields, "FailoverStage")
}

// SetFailoverStageNil sets FailoverStage to an explicit JSON null when marshaled.
func (o *ApiStandbyLinkFailoverResponse) SetFailoverStageNil() {
	o.FailoverStage = nil
	o.NullFields = addNullField(o.NullFields, "FailoverStage")
}
...
func (o *ApiStandbyLinkFailoverResponse) SetStandbyLinkId(v string) {
	o.StandbyLinkId = &v
	o.NullFields = removeNullField(o.NullFields, "StandbyLinkId")
}

// SetStandbyLinkIdNil sets StandbyLinkId to an explicit JSON null when marshaled.
func (o *ApiStandbyLinkFailoverResponse) SetStandbyLinkIdNil() {
	o.StandbyLinkId = nil
	o.NullFields = addNullField(o.NullFields, "StandbyLinkId")
}
...
func (o *ApiStandbyLinkFailoverResponse) SetStatusNil() {
	o.Status = nil
...
func (o *ApiStandbyLinkFailoverResponse) SetTypeNil() {
	o.Type = nil
