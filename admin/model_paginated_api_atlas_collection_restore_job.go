...
// PaginatedApiAtlasCollectionRestoreJob struct for PaginatedApiAtlasCollectionRestoreJob
type PaginatedApiAtlasCollectionRestoreJob struct {
...
func NewPaginatedApiAtlasCollectionRestoreJob(results []ApiAtlasCollectionRestoreJobResponse) *PaginatedApiAtlasCollectionRestoreJob {
	this := PaginatedApiAtlasCollectionRestoreJob{}
...
func (o *PaginatedApiAtlasCollectionRestoreJob) GetResults() []ApiAtlasCollectionRestoreJobResponse {
	if o == nil {
		var ret []ApiAtlasCollectionRestoreJobResponse
		return ret
	}
