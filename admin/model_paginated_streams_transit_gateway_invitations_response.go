...
type PaginatedStreamsTransitGatewayInvitationsResponse struct {
	...
	// Read only field.
	Results []StreamsTransitGatewayInvitationsResponse `json:"results"`
...
func (o *PaginatedStreamsTransitGatewayInvitationsResponse) MarshalJSON() ([]byte, error) {
	type noMethod PaginatedStreamsTransitGatewayInvitationsResponse
...
func NewPaginatedStreamsTransitGatewayInvitationsResponse(results []StreamsTransitGatewayInvitationsResponse) *PaginatedStreamsTransitGatewayInvitationsResponse {
...
func (o *PaginatedStreamsTransitGatewayInvitationsResponse) SetLinksNil() {
	o.Links = nil
...
func (o *PaginatedStreamsTransitGatewayInvitationsResponse) SetTotalCountNil() {
	o.TotalCount = nil
