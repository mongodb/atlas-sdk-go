...
// RateLimitEndpointSetRefillDurationSeconds The rate limit refill duration for the endpoint set.
type RateLimitEndpointSetRefillDurationSeconds struct {
...
func NewRateLimitEndpointSetRefillDurationSeconds() *RateLimitEndpointSetRefillDurationSeconds {
	this := RateLimitEndpointSetRefillDurationSeconds{}
	return &this
}
