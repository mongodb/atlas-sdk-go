...
type GroupsApi interface {
	...
	/*
		...
		[experimental] Assigns the specified organization Service Account to the specified project.
	...
	*/
	...
	/*
		...
		[experimental] Creates and assigns the specified Service Account to the specified Project.
	...
	*/
	...
	/*
		...
		[experimental] Removes one Service Account from the specified project.
	...
	*/
	...
	/*
		...
		[experimental] Get project Service Account Details.
	...
	*/
	...
	// Method available only for mocking purposes
	GetProjectServiceAccountExecute(r GetProjectServiceAccountApiRequest) (*GroupServiceAccountDetails, *http.Response, error)

	/*
		ListProjectServiceAccounts Return All project Service Accounts

		[experimental] Returns list of Service Accounts for a project with service account details.
	...
	*/
	...
	/*
		...
		[experimental] Update Service Account in Project.
	...
	*/
	...
	// Method available only for mocking purposes
	UpdateProjectServiceAccountExecute(r UpdateProjectServiceAccountApiRequest) (*GroupServiceAccountDetails, *http.Response, error)
}
...
func (r GetProjectServiceAccountApiRequest) Execute() (*GroupServiceAccountDetails, *http.Response, error) {
...
// Execute executes the request
//
//	@return GroupServiceAccountDetails
func (a *GroupsApiService) GetProjectServiceAccountExecute(r GetProjectServiceAccountApiRequest) (*GroupServiceAccountDetails, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GroupServiceAccountDetails
	)
...
func (r UpdateProjectServiceAccountApiRequest) Execute() (*GroupServiceAccountDetails, *http.Response, error) {
...
//
//	@return GroupServiceAccountDetails
func (a *GroupsApiService) UpdateProjectServiceAccountExecute(r UpdateProjectServiceAccountApiRequest) (*GroupServiceAccountDetails, *http.Response, error) {
	var (
