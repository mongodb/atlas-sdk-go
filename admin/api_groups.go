...
type GroupsApi interface {
	...
	*/
	...
	AddProjectServiceAccountExecute(r AddProjectServiceAccountApiRequest) (interface{}, *http.Response, error)
	...
	*/
	...
	// Method available only for mocking purposes
	DeleteProjectServiceAccountExecute(r DeleteProjectServiceAccountApiRequest) (interface{}, *http.Response, error)
...
func (r AddProjectServiceAccountApiRequest) Execute() (interface{}, *http.Response, error) {
...
//
//	@return interface{}
func (a *GroupsApiService) AddProjectServiceAccountExecute(r AddProjectServiceAccountApiRequest) (interface{}, *http.Response, error) {
	var (
...
func (r DeleteProjectServiceAccountApiRequest) Execute() (interface{}, *http.Response, error) {
...
//
//	@return interface{}
func (a *GroupsApiService) DeleteProjectServiceAccountExecute(r DeleteProjectServiceAccountApiRequest) (interface{}, *http.Response, error) {
	var (
