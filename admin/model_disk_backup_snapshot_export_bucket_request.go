...
type DiskBackupSnapshotExportBucketRequest struct {
	...
	// Human-readable label that identifies the AWS S3 Bucket that the role is authorized to export to.  Alternatively: The name of the Azure Storage Container to export to. This can be omitted and computed from the serviceUrl if the serviceUrl includes a Azure Storage Container name. For example a serviceUrl of \"https://examplestorageaccount.blob.core.windows.net/exportcontainer\" will yield a computed bucketName of \"exportcontainer\". If the serviceUrl does not include a Container name, this field is required.
...
func (o DiskBackupSnapshotExportBucketRequest) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o DiskBackupSnapshotExportBucketRequest) ToMap() (map[string]interface{}, error) {
