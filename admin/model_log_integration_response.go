...
type LogIntegrationResponse struct {
	...
	// Human-readable label that identifies the service to which you want to integrate with Atlas. The value must match the log integration type.
	...
	// Unique 24-character hexadecimal string that identifies the Service Principal.
...
func (o *LogIntegrationResponse) GetServicePrincipalId() string {
...
// and a boolean to check if the value has been set.
func (o *LogIntegrationResponse) GetServicePrincipalIdOk() (*string, bool) {
	if o == nil || IsNil(o.ServicePrincipalId) {
		return nil, false
	}
...
func (o *LogIntegrationResponse) HasServicePrincipalId() bool {
	if o != nil && !IsNil(o.ServicePrincipalId) {
		return true
	}
...
func (o *LogIntegrationResponse) SetServicePrincipalId(v string) {
