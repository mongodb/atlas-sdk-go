...
type FlexSnapshotsApi interface {
	...
	*/
	...
	DownloadFlexBackupExecute(r DownloadFlexBackupApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error)
...
func (r DownloadFlexBackupApiRequest) Execute() (*FlexBackupRestoreJob20250101, *http.Response, error) {
...
func (a *FlexSnapshotsApiService) DownloadFlexBackupExecute(r DownloadFlexBackupApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error) {
	var (
