...
type DedicatedHardwareSpec struct {
	// Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.  Alternatively: Number of nodes of the given type for MongoDB Cloud to deploy to the region.
