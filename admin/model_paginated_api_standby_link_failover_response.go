...
type PaginatedApiStandbyLinkFailoverResponse struct {
	...
	// Read only field.
	Results []ApiStandbyLinkFailoverResponse `json:"results"`
...
func (o *PaginatedApiStandbyLinkFailoverResponse) MarshalJSON() ([]byte, error) {
	type noMethod PaginatedApiStandbyLinkFailoverResponse
...
func NewPaginatedApiStandbyLinkFailoverResponse(results []ApiStandbyLinkFailoverResponse) *PaginatedApiStandbyLinkFailoverResponse {
...
func (o *PaginatedApiStandbyLinkFailoverResponse) SetLinksNil() {
	o.Links = nil
...
func (o *PaginatedApiStandbyLinkFailoverResponse) SetTotalCountNil() {
	o.TotalCount = nil
