...
type OpenAPIApi interface {
	...
	/*
		...
		API that provides a list of available versionsfor a given environment. Deprecated versions: v2-{2024-08-05}
	...
	*/
	...
	/*
		...
		This resource returns general information about the MongoDB Atlas Administration API OpenAPI Specification. Deprecated versions: v2-{2024-08-05}, v2-{2024-05-30}
