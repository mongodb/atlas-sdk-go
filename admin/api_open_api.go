...
type OpenAPIAPI interface {
	...
	/*
		 ...
		 This resource returns general information about the MongoDB Atlas Administration API OpenAPI Specification. Deprecated versions: v2-{2025-09-22.upcoming}, v2-{2024-08-05}, v2-{2024-05-30}

			@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			@return GetOpenapiInfoApiRequest

			Deprecated: this method has been deprecated. Please check the latest resource version for OpenAPIAPI
	*/
	...
	*/
	...
	/*
		 ...
		 API that provides a list of available versions for a given environment. Deprecated versions: v2-{2024-08-05}
...
// The environment to get the versions from. If not provided, it returns the versions for the given MongoDB URL. (E.g. prod for cloud.mongodb.com).
