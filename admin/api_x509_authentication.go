...
type X509AuthenticationApi interface {
	...
	*/
	...
	/*
			DisableUserSecurityCustomer Disable Customer-Managed X.509
		 ...
		 Updating this configuration triggers a rolling restart of the database. You must have the Project Owner role to use this endpoint.
			...
			@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			@param groupId Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.
			@return DisableUserSecurityCustomerApiRequest
	*/
	DisableUserSecurityCustomer(ctx context.Context, groupId string) DisableUserSecurityCustomerApiRequest
	/*
		DisableUserSecurityCustomer Disable Customer-Managed X.509


		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param DisableUserSecurityCustomerApiParams - Parameters for the request
		@return DisableUserSecurityCustomerApiRequest
	*/
	DisableUserSecurityCustomerWithParams(ctx context.Context, args *DisableUserSecurityCustomerApiParams) DisableUserSecurityCustomerApiRequest

	// Method available only for mocking purposes
	DisableUserSecurityCustomerExecute(r DisableUserSecurityCustomerApiRequest) (*UserSecurity, *http.Response, error)
...
type DisableUserSecurityCustomerApiRequest struct {
	ctx        context.Context
	ApiService X509AuthenticationApi
	groupId    string
}

type DisableUserSecurityCustomerApiParams struct {
	GroupId string
}

func (a *X509AuthenticationApiService) DisableUserSecurityCustomerWithParams(ctx context.Context, args *DisableUserSecurityCustomerApiParams) DisableUserSecurityCustomerApiRequest {
	return DisableUserSecurityCustomerApiRequest{
		ApiService: a,
		ctx:        ctx,
		groupId:    args.GroupId,
...
func (r DisableUserSecurityCustomerApiRequest) Execute() (*UserSecurity, *http.Response, error) {
	return r.ApiService.DisableUserSecurityCustomerExecute(r)
}
...
Clears the customer-managed X.509 settings on a project, including the uploaded Certificate Authority, which disables self-managed X.509.
	...
	@return DisableUserSecurityCustomerApiRequest
*/
func (a *X509AuthenticationApiService) DisableUserSecurityCustomer(ctx context.Context, groupId string) DisableUserSecurityCustomerApiRequest {
	return DisableUserSecurityCustomerApiRequest{
		ApiService: a,
		ctx:        ctx,
		groupId:    groupId,
...
// DisableUserSecurityCustomerExecute executes the request
//
//	@return UserSecurity
func (a *X509AuthenticationApiService) DisableUserSecurityCustomerExecute(r DisableUserSecurityCustomerApiRequest) (*UserSecurity, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "X509AuthenticationApiService.DisableUserSecurityCustomer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
