...
func (o *ClusterDescriptionProcessArgs) GetCustomOpensslCipherConfigTls13() []string {
...
// and a boolean to check if the value has been set.
func (o *ClusterDescriptionProcessArgs) GetCustomOpensslCipherConfigTls13Ok() (*[]string, bool) {
	if o == nil || IsNil(o.CustomOpensslCipherConfigTls13) {
		return nil, false
	}
...
func (o *ClusterDescriptionProcessArgs) HasCustomOpensslCipherConfigTls13() bool {
	if o != nil && !IsNil(o.CustomOpensslCipherConfigTls13) {
		return true
	}
...
func (o *ClusterDescriptionProcessArgs) SetCustomOpensslCipherConfigTls13(v []string) {
