...
type OnlineArchiveApi interface {
	...
	*/
	...
	/*
		DownloadOnlineArchiveQueryLogs [experimental] Downloads query logs for the specified online archive. To use this resource, the requesting API Key must have the Project Data Access Read Only or higher role. This resource doesn't require the API Key to have an Access List.
