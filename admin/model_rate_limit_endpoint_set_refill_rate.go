...
// RateLimitEndpointSetRefillRate The rate limit refill rate for the endpoint set.
type RateLimitEndpointSetRefillRate struct {
...
func (o *RateLimitEndpointSetRefillRate) MarshalJSON() ([]byte, error) {
	type noMethod RateLimitEndpointSetRefillRate
...
func NewRateLimitEndpointSetRefillRate() *RateLimitEndpointSetRefillRate {
	this := RateLimitEndpointSetRefillRate{}
	return &this
}
