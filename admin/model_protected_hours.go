...
func (o ProtectedHours) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o ProtectedHours) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EndHourOfDay) {
		toSerialize["endHourOfDay"] = o.EndHourOfDay
	}
	if !IsNil(o.StartHourOfDay) {
		toSerialize["startHourOfDay"] = o.StartHourOfDay
	}
