...
type MongoDBCloudUsersApi interface {
	...
	*/
	...
	/*
			...
			Adds one MongoDB Cloud user to one project. To use this resource, the requesting API Key must have the Group User Admin role.
	...
	*/
	...
	/*
			...
			Returns information about the specified MongoDB Cloud user within the context of the specified project. To use this resource, the requesting API Key must have the Group Read Only role.
