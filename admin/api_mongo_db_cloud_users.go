...
type MongoDBCloudUsersApi interface {
	...
	*/
	RemoveOrganizationRole(ctx context.Context, orgId string, userId string) RemoveOrganizationRoleApiRequest
	/*
		RemoveOrganizationRole Remove One Organization Role from One MongoDB Cloud User
...
// Organization level role to remove from the MongoDB Cloud user.
func (r RemoveOrganizationRoleApiRequest) Role(role string) RemoveOrganizationRoleApiRequest {
	r.role = &role
	return r
}
...
**Note**: This resource cannot be used to remove a role from users invited using the deprecated [Invite One MongoDB Cloud User to Join One Project](#tag/Projects/operation/createProjectInvitation) endpoint.
	...
	@return RemoveOrganizationRoleApiRequest
*/
func (a *MongoDBCloudUsersApiService) RemoveOrganizationRole(ctx context.Context, orgId string, userId string) RemoveOrganizationRoleApiRequest {
	return RemoveOrganizationRoleApiRequest{
		ApiService: a,
		ctx:        ctx,
		orgId:      orgId,
