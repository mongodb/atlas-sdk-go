...
// EphemeralClusterCreated Details for the Atlas Ephemeral cluster that was created.
type EphemeralClusterCreated struct {
	// Unique URL for claiming this Ephemeral cluster. Redirects to the Atlas sign-in or registration page, where a user signs in or creates an account to claim the cluster. Valid for 7 days after the cluster is created.
	ClaimUrl *string `json:"claimUrl,omitempty"`
	// Unique identifier of the Ephemeral cluster. Use this ID to retrieve the cluster's status and details in a GET request.
	ClusterId *string `json:"clusterId,omitempty"`
	// Connection string that uses the `mongodb+srv://` protocol to connect to the Ephemeral cluster. This string includes the unredacted SCRAM credentials (username and password) for an automatically generated database user that Atlas grants the built-in `readWriteAnyDatabase` role.
	...
	// Notice that by using this API, you agree to MongoDB's Cloud Terms of Service at <https://www.mongodb.com/legal/terms-and-conditions/cloud> and Privacy Policy at <https://www.mongodb.com/legal/privacy/privacy-policy>. Includes a link to the full terms.
...
func (o *EphemeralClusterCreated) MarshalJSON() ([]byte, error) {
	type noMethod EphemeralClusterCreated
...
func (o *EphemeralClusterCreated) SetClaimUrlNil() {
	o.ClaimUrl = nil
...
func (o *EphemeralClusterCreated) SetClusterIdNil() {
	o.ClusterId = nil
...
func (o *EphemeralClusterCreated) SetConnectionStringNil() {
...
func (o *EphemeralClusterCreated) SetExpiresAtNil() {
	o.ExpiresAt = nil
...
func (o *EphemeralClusterCreated) SetStatusNil() {
	o.Status = nil
...
func (o *EphemeralClusterCreated) SetTermsOfServiceNil() {
