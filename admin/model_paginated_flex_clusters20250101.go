...
func (o *PaginatedFlexClusters20250101) GetResults() []interface{} {
...
// and a boolean to check if the value has been set.
func (o *PaginatedFlexClusters20250101) GetResultsOk() (*[]interface{}, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
func (o *PaginatedFlexClusters20250101) SetResults(v []interface{}) {
	o.Results = &v
}
...
func (o *PaginatedFlexClusters20250101) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o *PaginatedFlexClusters20250101) ToMap() (map[string]interface{}, error) {
