...
type DiskBackupCopySetting struct {
	...
	// List that describes retention per copy policy item. Allowed only when `copyPolicyItemsEnabled` is true. Responses omit this field when `copyPolicyItemsEnabled` is false or omitted.
	...
	// Target region to copy snapshots belonging to `replicationSpecId` to. Please supply the 'Atlas Region'.
	RegionName *string `json:"regionName,omitempty"`
	// Unique 24-hexadecimal digit string that identifies the replication object for a zone in a cluster. For global clusters, there can be multiple zones to choose from. For sharded clusters and replica set clusters, there is only one zone in the cluster. To find the Replication Specification ID, do a GET request to Return One Cluster from One Project and consult the `replicationSpecs` array.
...
func (o *DiskBackupCopySetting) GetCopyPolicyItems() []DiskBackupCopyPolicyItem {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupCopySetting) GetCopyPolicyItemsOk() (*[]DiskBackupCopyPolicyItem, bool) {
	if o == nil || IsNil(o.CopyPolicyItems) {
		return nil, false
	}
...
func (o *DiskBackupCopySetting) HasCopyPolicyItems() bool {
	if o != nil && !IsNil(o.CopyPolicyItems) {
		return true
	}
...
func (o *DiskBackupCopySetting) SetCopyPolicyItems(v []DiskBackupCopyPolicyItem) {
	o.CopyPolicyItems = &v
}
...
func (o *DiskBackupCopySetting) GetLastNumberOfSnapshots() int {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupCopySetting) GetLastNumberOfSnapshotsOk() (*int, bool) {
	if o == nil || IsNil(o.LastNumberOfSnapshots) {
		return nil, false
	}
...
func (o *DiskBackupCopySetting) HasLastNumberOfSnapshots() bool {
	if o != nil && !IsNil(o.LastNumberOfSnapshots) {
		return true
	}
...
func (o *DiskBackupCopySetting) SetLastNumberOfSnapshots(v int) {
