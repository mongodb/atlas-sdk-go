...
type AIModelRateLimitsAPI interface {
	...
	*/
	...
	// Method available only for mocking purposes
	ResetModelRateLimitExecute(r ResetModelRateLimitApiRequest) (*AiModelsRateLimitResponse, *http.Response, error)
	...
	*/
	...
	// Method available only for mocking purposes
	ResetModelRateLimitsExecute(r ResetModelRateLimitsApiRequest) (*PaginatedAtlasAiModelsRateLimitsResponse, *http.Response, error)
...
func (a *AIModelRateLimitsAPIService) GetGroupModelLimitExecute(r GetGroupModelLimitApiRequest) (*AiModelsRateLimitResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/atlas/v2/groups/{groupId}/aiModelApiRateLimits/{modelGroupName}"
	if r.groupId == "" {
...
func (a *AIModelRateLimitsAPIService) GetOrgModelLimitExecute(r GetOrgModelLimitApiRequest) (*AiModelsRateLimitResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/atlas/v2/orgs/{orgId}/aiModelApiRateLimits/{modelGroupName}"
	if r.orgId == "" {
...
func (r ResetModelRateLimitApiRequest) Execute() (*AiModelsRateLimitResponse, *http.Response, error) {
...
//
//	@return AiModelsRateLimitResponse
func (a *AIModelRateLimitsAPIService) ResetModelRateLimitExecute(r ResetModelRateLimitApiRequest) (*AiModelsRateLimitResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/api/atlas/v2/groups/{groupId}/aiModelApiRateLimits/{modelGroupName}:reset"
	if r.groupId == "" {
		return localVarReturnValue, nil, reportError("groupId is empty and must be specified")
	}
	localVarPath = strings.Replace(localVarPath, "{"+"groupId"+"}", url.PathEscape(r.groupId), -1)
...
func (r ResetModelRateLimitsApiRequest) Execute() (*PaginatedAtlasAiModelsRateLimitsResponse, *http.Response, error) {
...
//
//	@return PaginatedAtlasAiModelsRateLimitsResponse
func (a *AIModelRateLimitsAPIService) ResetModelRateLimitsExecute(r ResetModelRateLimitsApiRequest) (*PaginatedAtlasAiModelsRateLimitsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    any
		formFiles           []formFile
