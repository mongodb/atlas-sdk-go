...
// PaginatedOrgServiceAccounts A list of Organization Service Accounts.
...
func (o *PaginatedOrgServiceAccounts) MarshalJSON() ([]byte, error) {
	type noMethod PaginatedOrgServiceAccounts
