...
// PaginatedOrgServiceAccounts List of Service Accounts
type PaginatedOrgServiceAccounts struct {
	// List of one or more Uniform Resource Locators (URLs) that point to API sub-resources, related API resources, or both. RFC 5988 outlines these relationships.
	// Read only field.
	Links *[]Link `json:"links,omitempty"`
	// List of returned documents that MongoDB Cloud providers when completing this request.
	// Read only field.
	Results *[]OrgServiceAccountDetails `json:"results,omitempty"`
...
func NewPaginatedOrgServiceAccounts() *PaginatedOrgServiceAccounts {
	this := PaginatedOrgServiceAccounts{}
	return &this
}
...
func (o *PaginatedOrgServiceAccounts) GetResults() []OrgServiceAccountDetails {
	if o == nil || IsNil(o.Results) {
		var ret []OrgServiceAccountDetails
		return ret
	}
	return *o.Results
}
...
// and a boolean to check if the value has been set.
func (o *PaginatedOrgServiceAccounts) GetResultsOk() (*[]OrgServiceAccountDetails, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
// SetResults gets a reference to the given []OrgServiceAccountDetails and assigns it to the Results field.
func (o *PaginatedOrgServiceAccounts) SetResults(v []OrgServiceAccountDetails) {
	o.Results = &v
}
...
func (o PaginatedOrgServiceAccounts) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o PaginatedOrgServiceAccounts) ToMap() (map[string]interface{}, error) {
