...
type SearchMappings struct {
	// Indicates whether the index uses static, dynamic, or configurable dynamic mappings. Required if **mappings.fields** is omitted. Referred type sets must be defined in **typeSets** field.
