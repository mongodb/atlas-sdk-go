...
func (o *OrgServiceAccountUpdateRequest) GetRoleNames() []string {
...
// and a boolean to check if the value has been set.
func (o *OrgServiceAccountUpdateRequest) GetRoleNamesOk() (*[]string, bool) {
	if o == nil || IsNil(o.RoleNames) {
		return nil, false
	}
...
func (o *OrgServiceAccountUpdateRequest) HasRoleNames() bool {
	if o != nil && !IsNil(o.RoleNames) {
		return true
	}
...
func (o *OrgServiceAccountUpdateRequest) SetRoleNames(v []string) {
	o.RoleNames = &v
}

func (o OrgServiceAccountUpdateRequest) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o OrgServiceAccountUpdateRequest) ToMap() (map[string]interface{}, error) {
