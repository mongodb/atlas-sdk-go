...
type OrgServiceAccountUpdateRequest struct {
	...
	// Human-readable name for the service account. The name name is modifiable and does not have to be unique.
	Name *string `json:"name,omitempty"`
	// Organization roles associated with the Service account.
