...
func (o *SandboxClusterTemplate) MarshalJSON() ([]byte, error) {
	type noMethod SandboxClusterTemplate
...
func (o *SandboxClusterTemplate) SetProviderNil() {
	o.Provider = nil
...
func (o *SandboxClusterTemplate) SetRegionNil() {
	o.Region = nil
...
func (o *SandboxClusterTemplate) SetTierNil() {
	o.Tier = nil
