...
type FlexRestoreJobsApi interface {
	...
	/*
		...
		Restores one snapshot of one flex cluster from the specified project. To use this resource, the requesting API Key must have the Project Owner role.
		...
		@param flexBackupRestoreJobCreate20250101 Restores one snapshot of one flex cluster from the specified project.
		@return CreateFlexBackupRestoreJobApiRequest
	*/
	CreateFlexBackupRestoreJob(ctx context.Context, groupId string, name string, flexBackupRestoreJobCreate20250101 *FlexBackupRestoreJobCreate20250101) CreateFlexBackupRestoreJobApiRequest
	/*
		CreateFlexBackupRestoreJob Restore One Snapshot of One Flex Cluster
	...
	*/
	...
	CreateFlexBackupRestoreJobExecute(r CreateFlexBackupRestoreJobApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error)

	/*
		GetFlexBackupRestoreJob Return One Restore Job for One Flex Cluster

		Returns one restore job for one flex cluster from the specified project. To use this resource, the requesting API Key must have the Project Owner role.
	...
	*/
	...
	// Method available only for mocking purposes
	GetFlexBackupRestoreJobExecute(r GetFlexBackupRestoreJobApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error)

	/*
		ListFlexBackupRestoreJobs Return All Restore Jobs for One Flex Cluster

		Returns all restore jobs for one flex cluster from the specified project. To use this resource, the requesting API Key must have the Project Owner role.
...
type CreateFlexBackupRestoreJobApiRequest struct {
	...
	groupId                            string
	name                               string
	flexBackupRestoreJobCreate20250101 *FlexBackupRestoreJobCreate20250101
}
...
func (a *FlexRestoreJobsApiService) CreateFlexBackupRestoreJobWithParams(ctx context.Context, args *CreateFlexBackupRestoreJobApiParams) CreateFlexBackupRestoreJobApiRequest {
	return CreateFlexBackupRestoreJobApiRequest{
		...
		name:                               args.Name,
		flexBackupRestoreJobCreate20250101: args.FlexBackupRestoreJobCreate20250101,
	}
}

func (r CreateFlexBackupRestoreJobApiRequest) Execute() (*FlexBackupRestoreJob20250101, *http.Response, error) {
...
Restores one snapshot of one flex cluster from the specified project. To use this resource, the requesting API Key must have the Project Owner role.
	...
	@return CreateFlexBackupRestoreJobApiRequest
*/
func (a *FlexRestoreJobsApiService) CreateFlexBackupRestoreJob(ctx context.Context, groupId string, name string, flexBackupRestoreJobCreate20250101 *FlexBackupRestoreJobCreate20250101) CreateFlexBackupRestoreJobApiRequest {
	return CreateFlexBackupRestoreJobApiRequest{
		ApiService:                         a,
		ctx:                                ctx,
		groupId:                            groupId,
...
//
//	@return FlexBackupRestoreJob20250101
func (a *FlexRestoreJobsApiService) CreateFlexBackupRestoreJobExecute(r CreateFlexBackupRestoreJobApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    any
		formFiles           []formFile
		localVarReturnValue *FlexBackupRestoreJob20250101
	)
	...
	if r.flexBackupRestoreJobCreate20250101 == nil {
		return localVarReturnValue, nil, reportError("flexBackupRestoreJobCreate20250101 is required and must be specified")
	}
	...
	localVarHTTPHeaderAccepts := []string{"application/vnd.atlas.2024-11-13+json", "application/json"}
	...
	// body params
	localVarPostBody = r.flexBackupRestoreJobCreate20250101
...
func (r GetFlexBackupRestoreJobApiRequest) Execute() (*FlexBackupRestoreJob20250101, *http.Response, error) {
...
//
//	@return FlexBackupRestoreJob20250101
func (a *FlexRestoreJobsApiService) GetFlexBackupRestoreJobExecute(r GetFlexBackupRestoreJobApiRequest) (*FlexBackupRestoreJob20250101, *http.Response, error) {
	var (
