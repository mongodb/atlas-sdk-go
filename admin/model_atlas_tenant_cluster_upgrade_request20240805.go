...
func (o *AtlasTenantClusterUpgradeRequest20240805) HasEffectiveIntelligentWorkloadManagementPolicies() bool {
	if o != nil && !IsNil(o.EffectiveIntelligentWorkloadManagementPolicies) {
		return true
	}
...
func (o *AtlasTenantClusterUpgradeRequest20240805) GetIntelligentWorkloadManagementPolicyOverrides() map[string]any {
...
// and a boolean to check if the value has been set.
func (o *AtlasTenantClusterUpgradeRequest20240805) GetIntelligentWorkloadManagementPolicyOverridesOk() (*map[string]any, bool) {
	if o == nil || IsNil(o.IntelligentWorkloadManagementPolicyOverrides) {
		return nil, false
	}
...
func (o *AtlasTenantClusterUpgradeRequest20240805) HasIntelligentWorkloadManagementPolicyOverrides() bool {
	if o != nil && !IsNil(o.IntelligentWorkloadManagementPolicyOverrides) {
		return true
	}
...
func (o *AtlasTenantClusterUpgradeRequest20240805) SetIntelligentWorkloadManagementPolicyOverrides(v map[string]any) {
