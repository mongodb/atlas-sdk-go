...
func NewDiskBackupSnapshotSchedule(policies []AdvancedDiskBackupSnapshotSchedulePolicy) *DiskBackupSnapshotSchedule {
...
func (o *DiskBackupSnapshotSchedule) GetCopyPolicyItemsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupSnapshotSchedule) GetCopyPolicyItemsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.CopyPolicyItemsEnabled) {
		return nil, false
	}
...
func (o *DiskBackupSnapshotSchedule) HasCopyPolicyItemsEnabled() bool {
	if o != nil && !IsNil(o.CopyPolicyItemsEnabled) {
		return true
	}
...
func (o *DiskBackupSnapshotSchedule) SetCopyPolicyItemsEnabled(v bool) {
...
func (o *DiskBackupSnapshotSchedule) GetDeleteCopySnapshots() bool {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupSnapshotSchedule) GetDeleteCopySnapshotsOk() (*bool, bool) {
	if o == nil || IsNil(o.DeleteCopySnapshots) {
		return nil, false
	}
...
func (o *DiskBackupSnapshotSchedule) HasDeleteCopySnapshots() bool {
	if o != nil && !IsNil(o.DeleteCopySnapshots) {
		return true
	}
...
func (o *DiskBackupSnapshotSchedule) SetDeleteCopySnapshots(v bool) {
	o.DeleteCopySnapshots = &v
}

// GetDeleteSnapshots returns the DeleteSnapshots field value if set, zero value otherwise
func (o *DiskBackupSnapshotSchedule) GetDeleteSnapshots() bool {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupSnapshotSchedule) GetDeleteSnapshotsOk() (*bool, bool) {
	if o == nil || IsNil(o.DeleteSnapshots) {
		return nil, false
	}
...
func (o *DiskBackupSnapshotSchedule) HasDeleteSnapshots() bool {
	if o != nil && !IsNil(o.DeleteSnapshots) {
		return true
	}
...
func (o *DiskBackupSnapshotSchedule) SetDeleteSnapshots(v bool) {
	o.DeleteSnapshots = &v
}
...
func (o *DiskBackupSnapshotSchedule) GetUpdateCopySnapshots() bool {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupSnapshotSchedule) GetUpdateCopySnapshotsOk() (*bool, bool) {
	if o == nil || IsNil(o.UpdateCopySnapshots) {
		return nil, false
	}
...
func (o *DiskBackupSnapshotSchedule) HasUpdateCopySnapshots() bool {
	if o != nil && !IsNil(o.UpdateCopySnapshots) {
		return true
	}
...
func (o *DiskBackupSnapshotSchedule) SetUpdateCopySnapshots(v bool) {
