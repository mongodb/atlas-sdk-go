...
type SandboxConfigResponse struct {
	...
	// The ID of the sandbox configuration.
	// Read only field.
...
func (o *SandboxConfigResponse) MarshalJSON() ([]byte, error) {
	type noMethod SandboxConfigResponse
...
func (o *SandboxConfigResponse) SetClusterTemplateNil() {
...
func (o *SandboxConfigResponse) SetEnabledNil() {
	o.Enabled = nil
...
func (o *SandboxConfigResponse) SetIdNil() {
	o.Id = nil
