...
func NewS3LogIntegrationRequest(bucketName string, iamRoleId string, prefixPath string, type_ string) *S3LogIntegrationRequest {
...
func (o *S3LogIntegrationRequest) HasLogTypes() bool {
	if o != nil && !IsNil(o.LogTypes) {
		return true
	}
