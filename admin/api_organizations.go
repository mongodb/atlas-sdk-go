...
type OrganizationsApi interface {
	...
	*/
	...
	/*
		...
		[experimental] Get Service Account Details.
	...
	*/
	...
	// Method available only for mocking purposes
	GetServiceAccountExecute(r GetServiceAccountApiRequest) (*OrgServiceAccountDetails, *http.Response, error)
	...
	*/
	...
	/*
		...
		[experimental] Returns list of Service Account projects.
	...
	*/
	...
	// Method available only for mocking purposes
	UpdateServiceAccountExecute(r UpdateServiceAccountApiRequest) (*OrgServiceAccountDetails, *http.Response, error)
}
...
func (r GetServiceAccountApiRequest) Execute() (*OrgServiceAccountDetails, *http.Response, error) {
...
// Execute executes the request
//
//	@return OrgServiceAccountDetails
func (a *OrganizationsApiService) GetServiceAccountExecute(r GetServiceAccountApiRequest) (*OrgServiceAccountDetails, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *OrgServiceAccountDetails
	)
...
func (r UpdateServiceAccountApiRequest) Execute() (*OrgServiceAccountDetails, *http.Response, error) {
...
//
//	@return OrgServiceAccountDetails
func (a *OrganizationsApiService) UpdateServiceAccountExecute(r UpdateServiceAccountApiRequest) (*OrgServiceAccountDetails, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
