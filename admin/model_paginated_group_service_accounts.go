...
// PaginatedGroupServiceAccounts List of Service Accounts
type PaginatedGroupServiceAccounts struct {
	...
	// Read only field.
	Results *[]GroupServiceAccountDetails `json:"results,omitempty"`
...
func (o *PaginatedGroupServiceAccounts) GetResults() []GroupServiceAccountDetails {
	if o == nil || IsNil(o.Results) {
		var ret []GroupServiceAccountDetails
		return ret
	}
	return *o.Results
}
...
// and a boolean to check if the value has been set.
func (o *PaginatedGroupServiceAccounts) GetResultsOk() (*[]GroupServiceAccountDetails, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
// SetResults gets a reference to the given []GroupServiceAccountDetails and assigns it to the Results field.
func (o *PaginatedGroupServiceAccounts) SetResults(v []GroupServiceAccountDetails) {
	o.Results = &v
}
...
func (o PaginatedGroupServiceAccounts) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o PaginatedGroupServiceAccounts) ToMap() (map[string]interface{}, error) {
