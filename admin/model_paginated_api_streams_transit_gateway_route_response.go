...
type PaginatedApiStreamsTransitGatewayRouteResponse struct {
	...
	// Read only field.
	Results *[]StreamsTransitGatewayRouteResponse `json:"results,omitempty"`
...
func NewPaginatedApiStreamsTransitGatewayRouteResponse() *PaginatedApiStreamsTransitGatewayRouteResponse {
...
func (o *PaginatedApiStreamsTransitGatewayRouteResponse) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
// SetResults gets a reference to the given []StreamsTransitGatewayRouteResponse and assigns it to the Results field.
