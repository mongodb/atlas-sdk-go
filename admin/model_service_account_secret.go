...
type ServiceAccountSecret struct {
	...
	// Service Account secret with masked values of the first 20 characters.
	// Read only field.
	MaskedSecretValue *string `json:"maskedSecretValue,omitempty"`
	// Secret for the service account. It will be returned only the first time after service account creation.
	// Read only field.
