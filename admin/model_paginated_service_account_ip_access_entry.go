...
func (o *PaginatedServiceAccountIPAccessEntry) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o *PaginatedServiceAccountIPAccessEntry) ToMap() (map[string]interface{}, error) {
