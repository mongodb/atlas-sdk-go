...
type FlexClustersApi interface {
	...
	*/
	...
	// Method available only for mocking purposes
	DeleteFlexClusterExecute(r DeleteFlexClusterApiRequest) (interface{}, *http.Response, error)
...
func (r DeleteFlexClusterApiRequest) Execute() (interface{}, *http.Response, error) {
...
//
//	@return interface{}
func (a *FlexClustersApiService) DeleteFlexClusterExecute(r DeleteFlexClusterApiRequest) (interface{}, *http.Response, error) {
	var (
