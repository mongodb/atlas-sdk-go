...
func (o *FlexProviderSettingsCreate20250101) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o *FlexProviderSettingsCreate20250101) ToMap() (map[string]interface{}, error) {
