...
func (o *LogIntegrationRequest) GetServicePrincipalId() string {
...
// and a boolean to check if the value has been set.
func (o *LogIntegrationRequest) GetServicePrincipalIdOk() (*string, bool) {
	if o == nil || IsNil(o.ServicePrincipalId) {
		return nil, false
	}
...
func (o *LogIntegrationRequest) HasServicePrincipalId() bool {
	if o != nil && !IsNil(o.ServicePrincipalId) {
		return true
	}
...
func (o *LogIntegrationRequest) SetServicePrincipalId(v string) {
