...
func (a *RateLimitingAPIService) GetGroupRatelimitsWithParams(ctx context.Context, args *GetGroupRatelimitsApiParams) GetGroupRatelimitsApiRequest {
	return GetGroupRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
...
This API is in preview. Breaking changes might be introduced before it is released. Don't use preview APIs in production.
	...
	@return GetGroupRatelimitsApiRequest
*/
func (a *RateLimitingAPIService) GetGroupRatelimits(ctx context.Context, groupId string) GetGroupRatelimitsApiRequest {
	return GetGroupRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
		groupId:    groupId,
...
func (a *RateLimitingAPIService) GetGroupRatelimitsExecute(r GetGroupRatelimitsApiRequest) (*AtlasRateLimitInspectionResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RateLimitingAPIService.GetGroupRatelimits")
	if err != nil {
...
func (a *RateLimitingAPIService) GetOrgRatelimitsWithParams(ctx context.Context, args *GetOrgRatelimitsApiParams) GetOrgRatelimitsApiRequest {
	return GetOrgRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
		orgId:      args.OrgId,
...
This API is in preview. Breaking changes might be introduced before it is released. Don't use preview APIs in production.
	...
	@return GetOrgRatelimitsApiRequest
*/
func (a *RateLimitingAPIService) GetOrgRatelimits(ctx context.Context, orgId string) GetOrgRatelimitsApiRequest {
	return GetOrgRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
		orgId:      orgId,
...
//
//	@return AtlasRateLimitInspectionResponse
func (a *RateLimitingAPIService) GetOrgRatelimitsExecute(r GetOrgRatelimitsApiRequest) (*AtlasRateLimitInspectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RateLimitingAPIService.GetOrgRatelimits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
//
//	@return AtlasRateLimitInspectionResponse
func (a *RateLimitingAPIService) ListRatelimitsExecute(r ListRatelimitsApiRequest) (*AtlasRateLimitInspectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
...
func (a *RateLimitingAPIService) ListUserRatelimitsWithParams(ctx context.Context, args *ListUserRatelimitsApiParams) ListUserRatelimitsApiRequest {
	return ListUserRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
This API is in preview. Breaking changes might be introduced before it is released. Don't use preview APIs in production.
	...
	@return ListUserRatelimitsApiRequest
*/
func (a *RateLimitingAPIService) ListUserRatelimits(ctx context.Context) ListUserRatelimitsApiRequest {
	return ListUserRatelimitsApiRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return AtlasRateLimitInspectionResponse
func (a *RateLimitingAPIService) ListUserRatelimitsExecute(r ListUserRatelimitsApiRequest) (*AtlasRateLimitInspectionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    any
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RateLimitingAPIService.ListUserRatelimits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
