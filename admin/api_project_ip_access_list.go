...
type ProjectIPAccessListApi interface {
	...
	*/
	...
	/*
		GetProjectIpAccessListStatus [experimental] Returns the status of one project IP access list entry. This resource checks if the provided project IP access list entry applies to all cloud providers serving clusters from the specified project.
