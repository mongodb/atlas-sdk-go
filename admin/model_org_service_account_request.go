...
func NewOrgServiceAccountRequest(description string, name string, secretExpiresAfterHours int) *OrgServiceAccountRequest {
...
func (o *OrgServiceAccountRequest) HasRoles() bool {
	if o != nil && !IsNil(o.Roles) {
		return true
	}
