...
type PaginatedBackupSnapshotExportBucket struct {
	...
	// Read only field.
	Results []DiskBackupSnapshotAWSExportBucketResponse `json:"results"`
...
func NewPaginatedBackupSnapshotExportBucket(results []DiskBackupSnapshotAWSExportBucketResponse) *PaginatedBackupSnapshotExportBucket {
