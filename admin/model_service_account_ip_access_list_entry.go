...
type ServiceAccountIPAccessListEntry struct {
	...
	// Date MongoDB Cloud added the entry was added to the Access List.
	// Read only field.
...
func (o *ServiceAccountIPAccessListEntry) MarshalJSONWithoutReadOnly() ([]byte, error) {
...
func (o *ServiceAccountIPAccessListEntry) ToMap() (map[string]interface{}, error) {
