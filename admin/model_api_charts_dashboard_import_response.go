...
func (o *ApiChartsDashboardImportResponse) MarshalJSON() ([]byte, error) {
	type noMethod ApiChartsDashboardImportResponse
...
func NewApiChartsDashboardImportResponse(items []ImportedItem) *ApiChartsDashboardImportResponse {
...
func (o *ApiChartsDashboardImportResponse) SetDashboard(v ImportedDashboard) {
	o.Dashboard = &v
	o.NullFields = removeNullField(o.NullFields, "Dashboard")
}

// SetDashboardNil sets Dashboard to an explicit JSON null when marshaled.
func (o *ApiChartsDashboardImportResponse) SetDashboardNil() {
	o.Dashboard = nil
	o.NullFields = addNullField(o.NullFields, "Dashboard")
}
