...
type PaginatedLegacyCluster struct {
	...
	// Read only field.
	Results *[]LegacyAtlasCluster `json:"results,omitempty"`
...
func (o *PaginatedLegacyCluster) GetResults() []LegacyAtlasCluster {
	if o == nil || IsNil(o.Results) {
		var ret []LegacyAtlasCluster
		return ret
	}
	return *o.Results
}
...
// and a boolean to check if the value has been set.
func (o *PaginatedLegacyCluster) GetResultsOk() (*[]LegacyAtlasCluster, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
// SetResults gets a reference to the given []LegacyAtlasCluster and assigns it to the Results field.
func (o *PaginatedLegacyCluster) SetResults(v []LegacyAtlasCluster) {
	o.Results = &v
}
