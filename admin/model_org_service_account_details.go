...
func (o *OrgServiceAccountDetails) GetRoles() []string {
...
// and a boolean to check if the value has been set.
func (o *OrgServiceAccountDetails) GetRolesOk() (*[]string, bool) {
	if o == nil || IsNil(o.Roles) {
		return nil, false
	}
...
func (o *OrgServiceAccountDetails) HasRoles() bool {
	if o != nil && !IsNil(o.Roles) {
		return true
	}
...
func (o *OrgServiceAccountDetails) SetRoles(v []string) {
	o.Roles = &v
}
