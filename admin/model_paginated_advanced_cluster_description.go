...
type PaginatedAdvancedClusterDescription struct {
	...
	// Read only field.
	Results []AdvancedClusterDescription `json:"results"`
...
func NewPaginatedAdvancedClusterDescription(results []AdvancedClusterDescription) *PaginatedAdvancedClusterDescription {
