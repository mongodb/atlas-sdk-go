...
func (o *SqlInterfaceStatusResponse) MarshalJSON() ([]byte, error) {
	type noMethod SqlInterfaceStatusResponse
...
func (o *SqlInterfaceStatusResponse) SetSupported(v bool) {
	o.Supported = &v
	o.NullFields = removeNullField(o.NullFields, "Supported")
}

// SetSupportedNil sets Supported to an explicit JSON null when marshaled.
func (o *SqlInterfaceStatusResponse) SetSupportedNil() {
	o.Supported = nil
	o.NullFields = addNullField(o.NullFields, "Supported")
}
...
func (o *SqlInterfaceStatusResponse) SetUnsupportedReason(v string) {
	...
	o.NullFields = removeNullField(o.NullFields, "UnsupportedReason")
}

// SetUnsupportedReasonNil sets UnsupportedReason to an explicit JSON null when marshaled.
func (o *SqlInterfaceStatusResponse) SetUnsupportedReasonNil() {
	o.UnsupportedReason = nil
	o.NullFields = addNullField(o.NullFields, "UnsupportedReason")
}
