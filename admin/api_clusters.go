...
type ClustersApi interface {
	...
	/*
		...
		@param clusterDescription20240710 Cluster to create in the specific project.
		@return CreateClusterApiRequest
	*/
	CreateCluster(ctx context.Context, groupId string, clusterDescription20240710 *ClusterDescription20240710) CreateClusterApiRequest
	/*
		CreateCluster Create One Cluster from One Project
	...
	*/
	...
	CreateClusterExecute(r CreateClusterApiRequest) (*ClusterDescription20240710, *http.Response, error)
	...
	*/
	...
	// Method available only for mocking purposes
	GetClusterExecute(r GetClusterApiRequest) (*ClusterDescription20240710, *http.Response, error)
	...
	*/
	...
	// Method available only for mocking purposes
	GetClusterAdvancedConfigurationExecute(r GetClusterAdvancedConfigurationApiRequest) (*ClusterDescriptionProcessArgs20240710, *http.Response, error)
	...
	*/
	...
	// Method available only for mocking purposes
	ListClustersExecute(r ListClustersApiRequest) (*PaginatedClusterDescription20240710, *http.Response, error)
	...
	*/
	...
	/*
		...
		@param groupId Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.
		@param clusterName Human-readable label that identifies the cluster.
		@param clusterDescription20240710 Cluster to update in the specified project.
		@return UpdateClusterApiRequest
	*/
	UpdateCluster(ctx context.Context, groupId string, clusterName string, clusterDescription20240710 *ClusterDescription20240710) UpdateClusterApiRequest
	/*
		UpdateCluster Modify One Cluster from One Project
	...
	*/
	...
	// Method available only for mocking purposes
	UpdateClusterExecute(r UpdateClusterApiRequest) (*ClusterDescription20240710, *http.Response, error)
	...
	/*
		...
		@param groupId Unique 24-hexadecimal digit string that identifies your project. Use the [/groups](#tag/Projects/operation/listProjects) endpoint to retrieve all projects to which the authenticated user has access.  **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups.
		@param clusterName Human-readable label that identifies the cluster.
		@param clusterDescriptionProcessArgs20240710 Advanced configuration details to add for one cluster in the specified project.
		@return UpdateClusterAdvancedConfigurationApiRequest
	*/
	UpdateClusterAdvancedConfiguration(ctx context.Context, groupId string, clusterName string, clusterDescriptionProcessArgs20240710 *ClusterDescriptionProcessArgs20240710) UpdateClusterAdvancedConfigurationApiRequest
	/*
		UpdateClusterAdvancedConfiguration Update Advanced Configuration Options for One Cluster
	...
	*/
	...
	// Method available only for mocking purposes
	UpdateClusterAdvancedConfigurationExecute(r UpdateClusterAdvancedConfigurationApiRequest) (*ClusterDescriptionProcessArgs20240710, *http.Response, error)
...
type CreateClusterApiRequest struct {
	...
	groupId                    string
	clusterDescription20240710 *ClusterDescription20240710
}
...
func (a *ClustersApiService) CreateClusterWithParams(ctx context.Context, args *CreateClusterApiParams) CreateClusterApiRequest {
	return CreateClusterApiRequest{
		...
		clusterDescription20240710: args.ClusterDescription20240710,
	}
}

func (r CreateClusterApiRequest) Execute() (*ClusterDescription20240710, *http.Response, error) {
...
Creates one cluster in the specified project. Clusters contain a group of hosts that maintain the same data set. This resource can create clusters with asymmetrically-sized shards. Each project supports up to 25 database deployments. To use this resource, the requesting API Key must have the Project Owner role. This feature is not available for serverless clusters. Deprecated versions: v2-{2023-02-01}, v2-{2023-01-01}
	...
	@return CreateClusterApiRequest
*/
func (a *ClustersApiService) CreateCluster(ctx context.Context, groupId string, clusterDescription20240710 *ClusterDescription20240710) CreateClusterApiRequest {
	return CreateClusterApiRequest{
		ApiService:                 a,
		ctx:                        ctx,
		groupId:                    groupId,
...
//
//	@return ClusterDescription20240710
func (a *ClustersApiService) CreateClusterExecute(r CreateClusterApiRequest) (*ClusterDescription20240710, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterDescription20240710
	)
	...
	if r.clusterDescription20240710 == nil {
		return localVarReturnValue, nil, reportError("clusterDescription20240710 is required and must be specified")
	}

	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/vnd.atlas.2024-07-10+json"}
	...
	localVarHTTPHeaderAccepts := []string{"application/vnd.atlas.2024-07-10+json", "application/json"}
	...
	// body params
	localVarPostBody = r.clusterDescription20240710
...
func (r GetClusterApiRequest) Execute() (*ClusterDescription20240710, *http.Response, error) {
...
//
//	@return ClusterDescription20240710
func (a *ClustersApiService) GetClusterExecute(r GetClusterApiRequest) (*ClusterDescription20240710, *http.Response, error) {
	var (
...
func (r GetClusterAdvancedConfigurationApiRequest) Execute() (*ClusterDescriptionProcessArgs20240710, *http.Response, error) {
...
// Execute executes the request
//
//	@return ClusterDescriptionProcessArgs20240710
func (a *ClustersApiService) GetClusterAdvancedConfigurationExecute(r GetClusterAdvancedConfigurationApiRequest) (*ClusterDescriptionProcessArgs20240710, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ClusterDescriptionProcessArgs20240710
	)
...
func (r ListClustersApiRequest) Execute() (*PaginatedClusterDescription20240710, *http.Response, error) {
...
// Execute executes the request
//
//	@return PaginatedClusterDescription20240710
func (a *ClustersApiService) ListClustersExecute(r ListClustersApiRequest) (*PaginatedClusterDescription20240710, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *PaginatedClusterDescription20240710
	)
...
func (r UpdateClusterApiRequest) Execute() (*ClusterDescription20240710, *http.Response, error) {
...
Updates the details for one cluster in the specified project. Clusters contain a group of hosts that maintain the same data set. This resource can update clusters with asymmetrically-sized shards. To update a cluster's termination protection, the requesting API Key must have the Project Owner role. For all other updates, the requesting API Key must have the Project Cluster Manager role. You can't modify a paused cluster (`paused : true`). You must call this endpoint to set `paused : false`. After this endpoint responds with `paused : false`, you can call it again with the changes you want to make to the cluster. This feature is not available for serverless clusters. Deprecated versions: v2-{2023-02-01}, v2-{2023-01-01}
	...
	@return UpdateClusterApiRequest
*/
func (a *ClustersApiService) UpdateCluster(ctx context.Context, groupId string, clusterName string, clusterDescription20240710 *ClusterDescription20240710) UpdateClusterApiRequest {
	return UpdateClusterApiRequest{
		ApiService:                 a,
		ctx:                        ctx,
		groupId:                    groupId,
...
//
//	@return ClusterDescription20240710
func (a *ClustersApiService) UpdateClusterExecute(r UpdateClusterApiRequest) (*ClusterDescription20240710, *http.Response, error) {
	var (
...
type UpdateClusterAdvancedConfigurationApiRequest struct {
	...
	groupId                               string
	clusterName                           string
	clusterDescriptionProcessArgs20240710 *ClusterDescriptionProcessArgs20240710
}
...
func (a *ClustersApiService) UpdateClusterAdvancedConfigurationWithParams(ctx context.Context, args *UpdateClusterAdvancedConfigurationApiParams) UpdateClusterAdvancedConfigurationApiRequest {
	return UpdateClusterAdvancedConfigurationApiRequest{
		...
		groupId:                               args.GroupId,
		clusterName:                           args.ClusterName,
		clusterDescriptionProcessArgs20240710: args.ClusterDescriptionProcessArgs20240710,
	}
}

func (r UpdateClusterAdvancedConfigurationApiRequest) Execute() (*ClusterDescriptionProcessArgs20240710, *http.Response, error) {
...
Updates the advanced configuration details for one cluster in the specified project. Clusters contain a group of hosts that maintain the same data set. Advanced configuration details include the read/write concern, index and oplog limits, and other database settings. To use this resource, the requesting API Key must have the Project Cluster Manager role. This feature isn't available for `M0` free clusters, `M2` and `M5` shared-tier clusters, or serverless clusters. Deprecated versions: v2-{2023-01-01}
	...
	@return UpdateClusterAdvancedConfigurationApiRequest
*/
func (a *ClustersApiService) UpdateClusterAdvancedConfiguration(ctx context.Context, groupId string, clusterName string, clusterDescriptionProcessArgs20240710 *ClusterDescriptionProcessArgs20240710) UpdateClusterAdvancedConfigurationApiRequest {
	return UpdateClusterAdvancedConfigurationApiRequest{
		ApiService:                            a,
		ctx:                                   ctx,
		groupId:                               groupId,
...
//
//	@return ClusterDescriptionProcessArgs20240710
func (a *ClustersApiService) UpdateClusterAdvancedConfigurationExecute(r UpdateClusterAdvancedConfigurationApiRequest) (*ClusterDescriptionProcessArgs20240710, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.clusterDescriptionProcessArgs20240710 == nil {
		return localVarReturnValue, nil, reportError("clusterDescriptionProcessArgs20240710 is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.clusterDescriptionProcessArgs20240710
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
