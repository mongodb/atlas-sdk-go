...
type PaginatedApiStreamsTransitGatewayAttachmentResponse struct {
	...
	// Read only field.
	Results []StreamsTransitGatewayAttachmentResponse `json:"results"`
...
func (o *PaginatedApiStreamsTransitGatewayAttachmentResponse) MarshalJSON() ([]byte, error) {
	type noMethod PaginatedApiStreamsTransitGatewayAttachmentResponse
...
func NewPaginatedApiStreamsTransitGatewayAttachmentResponse(results []StreamsTransitGatewayAttachmentResponse) *PaginatedApiStreamsTransitGatewayAttachmentResponse {
...
func (o *PaginatedApiStreamsTransitGatewayAttachmentResponse) SetLinksNil() {
	o.Links = nil
...
func (o *PaginatedApiStreamsTransitGatewayAttachmentResponse) SetTotalCountNil() {
	o.TotalCount = nil
