...
func (o *ImportedDashboard) MarshalJSON() ([]byte, error) {
	type noMethod ImportedDashboard
...
func (o *ImportedDashboard) SetEmbeddingId(v string) {
	o.EmbeddingId = &v
	o.NullFields = removeNullField(o.NullFields, "EmbeddingId")
}

// SetEmbeddingIdNil sets EmbeddingId to an explicit JSON null when marshaled.
func (o *ImportedDashboard) SetEmbeddingIdNil() {
	o.EmbeddingId = nil
	o.NullFields = addNullField(o.NullFields, "EmbeddingId")
}
