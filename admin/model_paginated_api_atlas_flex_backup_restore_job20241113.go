...
// PaginatedApiAtlasFlexBackupRestoreJob20241113 struct for PaginatedApiAtlasFlexBackupRestoreJob20241113
type PaginatedApiAtlasFlexBackupRestoreJob20241113 struct {
	// List of one or more Uniform Resource Locators (URLs) that point to API sub-resources, related API resources, or both. RFC 5988 outlines these relationships.
	// Read only field.
	Links *[]Link `json:"links,omitempty"`
	// List of returned documents that MongoDB Cloud provides when completing this request.
	// Read only field.
	Results *[]FlexBackupRestoreJob20250101 `json:"results,omitempty"`
...
func NewPaginatedApiAtlasFlexBackupRestoreJob20241113() *PaginatedApiAtlasFlexBackupRestoreJob20241113 {
	this := PaginatedApiAtlasFlexBackupRestoreJob20241113{}
	return &this
}
...
func (o *PaginatedApiAtlasFlexBackupRestoreJob20241113) GetResults() []FlexBackupRestoreJob20250101 {
	if o == nil || IsNil(o.Results) {
		var ret []FlexBackupRestoreJob20250101
		return ret
	}
	return *o.Results
}
...
// and a boolean to check if the value has been set.
func (o *PaginatedApiAtlasFlexBackupRestoreJob20241113) GetResultsOk() (*[]FlexBackupRestoreJob20250101, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
// SetResults gets a reference to the given []FlexBackupRestoreJob20250101 and assigns it to the Results field.
func (o *PaginatedApiAtlasFlexBackupRestoreJob20241113) SetResults(v []FlexBackupRestoreJob20250101) {
	o.Results = &v
}
