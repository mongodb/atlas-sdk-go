...
type AWSClustersDNSApi interface {
	...
	/*
		GetAWSCustomDNS [experimental] Returns the custom DNS configuration for AWS clusters in the specified project. To use this resource, the requesting API Key must have the Project Read Only role. This resource doesn't require the API Key to have an Access List.
