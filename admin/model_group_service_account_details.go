...
func (o *GroupServiceAccountDetails) GetRoleNames() []string {
...
// and a boolean to check if the value has been set.
func (o *GroupServiceAccountDetails) GetRoleNamesOk() (*[]string, bool) {
	if o == nil || IsNil(o.RoleNames) {
		return nil, false
	}
...
func (o *GroupServiceAccountDetails) HasRoleNames() bool {
	if o != nil && !IsNil(o.RoleNames) {
		return true
	}
...
func (o *GroupServiceAccountDetails) SetRoleNames(v []string) {
	o.RoleNames = &v
}
