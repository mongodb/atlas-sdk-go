...
type MaintenanceWindowsApi interface {
	...
	*/
	...
	/*
		ToggleMaintenanceAutoDefer [experimental] Toggles automatic deferral of the maintenance window for the specified project. To use this resource, the requesting API Key must have the Project Owner role. This resource doesn't require the API Key to have an Access List.
