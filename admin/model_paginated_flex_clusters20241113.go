...
func (o *PaginatedFlexClusters20241113) GetResults() []any {
...
// and a boolean to check if the value has been set.
func (o *PaginatedFlexClusters20241113) GetResultsOk() (*[]any, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
func (o *PaginatedFlexClusters20241113) SetResults(v []any) {
	o.Results = &v
}
