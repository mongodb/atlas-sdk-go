...
func (o *AtlasRateLimitInspectionResponse) MarshalJSON() ([]byte, error) {
	type noMethod AtlasRateLimitInspectionResponse
...
func (o *AtlasRateLimitInspectionResponse) SetLimits(v []AtlasRateLimitBucketState) {
	o.Limits = &v
	o.NullFields = removeNullField(o.NullFields, "Limits")
}

// SetLimitsNil sets Limits to an explicit JSON null when marshaled.
func (o *AtlasRateLimitInspectionResponse) SetLimitsNil() {
	o.Limits = nil
	o.NullFields = addNullField(o.NullFields, "Limits")
}
...
func (o *AtlasRateLimitInspectionResponse) SetScopeNil() {
	o.Scope = nil
...
func (o *AtlasRateLimitInspectionResponse) SetScopeId(v string) {
	o.ScopeId = &v
	o.NullFields = removeNullField(o.NullFields, "ScopeId")
}

// SetScopeIdNil sets ScopeId to an explicit JSON null when marshaled.
func (o *AtlasRateLimitInspectionResponse) SetScopeIdNil() {
	o.ScopeId = nil
	o.NullFields = addNullField(o.NullFields, "ScopeId")
}
