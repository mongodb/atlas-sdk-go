...
func (o *ReplicationSpec) GetZoneId() string {
...
// and a boolean to check if the value has been set.
func (o *ReplicationSpec) GetZoneIdOk() (*string, bool) {
	if o == nil || IsNil(o.ZoneId) {
		return nil, false
	}
...
func (o *ReplicationSpec) HasZoneId() bool {
	if o != nil && !IsNil(o.ZoneId) {
		return true
	}
...
func (o *ReplicationSpec) SetZoneId(v string) {
	o.ZoneId = &v
}
