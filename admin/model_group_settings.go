...
func (o GroupSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsDataExplorerGenAIFeaturesEnabled) {
		toSerialize["isDataExplorerGenAIFeaturesEnabled"] = o.IsDataExplorerGenAIFeaturesEnabled
	}
	if !IsNil(o.IsDataExplorerGenAISampleDocumentPassingEnabled) {
		toSerialize["isDataExplorerGenAISampleDocumentPassingEnabled"] = o.IsDataExplorerGenAISampleDocumentPassingEnabled
	}
