...
func (o *GroupServiceAccount) GetRoleNames() []string {
...
// and a boolean to check if the value has been set.
func (o *GroupServiceAccount) GetRoleNamesOk() (*[]string, bool) {
	if o == nil || IsNil(o.RoleNames) {
		return nil, false
	}
...
func (o *GroupServiceAccount) HasRoleNames() bool {
	if o != nil && !IsNil(o.RoleNames) {
		return true
	}
...
func (o *GroupServiceAccount) SetRoleNames(v []string) {
	o.RoleNames = &v
}
