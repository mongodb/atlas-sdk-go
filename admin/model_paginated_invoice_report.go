...
// PaginatedInvoiceReport struct for PaginatedInvoiceReport
type PaginatedInvoiceReport struct {
...
func (o *PaginatedInvoiceReport) MarshalJSON() ([]byte, error) {
	type noMethod PaginatedInvoiceReport
