...
func (o *DiskBackupSnapshotAWSExportBucketRequest) GetRequirePrivateNetworking() bool {
...
// and a boolean to check if the value has been set.
func (o *DiskBackupSnapshotAWSExportBucketRequest) GetRequirePrivateNetworkingOk() (*bool, bool) {
	if o == nil || IsNil(o.RequirePrivateNetworking) {
		return nil, false
	}
...
func (o *DiskBackupSnapshotAWSExportBucketRequest) HasRequirePrivateNetworking() bool {
	if o != nil && !IsNil(o.RequirePrivateNetworking) {
		return true
	}
...
func (o *DiskBackupSnapshotAWSExportBucketRequest) SetRequirePrivateNetworking(v bool) {
