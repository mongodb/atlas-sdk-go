...
func (o *OrganizationMaintenanceSettingsResponse) MarshalJSON() ([]byte, error) {
	type noMethod OrganizationMaintenanceSettingsResponse
...
func (o *OrganizationMaintenanceSettingsResponse) SetEffectiveWaveAssignmentMode(v string) {
	...
	o.NullFields = removeNullField(o.NullFields, "EffectiveWaveAssignmentMode")
}

// SetEffectiveWaveAssignmentModeNil sets EffectiveWaveAssignmentMode to an explicit JSON null when marshaled.
func (o *OrganizationMaintenanceSettingsResponse) SetEffectiveWaveAssignmentModeNil() {
	o.EffectiveWaveAssignmentMode = nil
	o.NullFields = addNullField(o.NullFields, "EffectiveWaveAssignmentMode")
}
...
func (o *OrganizationMaintenanceSettingsResponse) SetWaveAssignmentMode(v string) {
	...
	o.NullFields = removeNullField(o.NullFields, "WaveAssignmentMode")
}

// SetWaveAssignmentModeNil sets WaveAssignmentMode to an explicit JSON null when marshaled.
func (o *OrganizationMaintenanceSettingsResponse) SetWaveAssignmentModeNil() {
	o.WaveAssignmentMode = nil
	o.NullFields = addNullField(o.NullFields, "WaveAssignmentMode")
}
