...
* [Authentication](./doc_4_authentication.md#authentication)

* [Advanced usage](./doc_5_advanced_usage.md#advanced-usage)
   * [Fluent and Struct Based API](./doc_5_advanced_usage.md#fluent-and-struct-based-api)
      * [Fluent API example](./doc_5_advanced_usage.md#fluent-api-example)
      * [Struct based API example](./doc_5_advanced_usage.md#struct-based-api-example)
