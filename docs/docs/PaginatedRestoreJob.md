...
**Results** | [**[]BackupRestoreJob**](BackupRestoreJob.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedRestoreJob(results []BackupRestoreJob, ) *PaginatedRestoreJob`
...
`func (o *PaginatedRestoreJob) SetLinksNil()`
...
`func (o *PaginatedRestoreJob) SetTotalCountNil()`
