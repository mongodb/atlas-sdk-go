...
SetTokenNil sets Token to an explicit JSON null when marshaled, overriding any value previously set with SetToken. Calling SetToken again clears the null override.
