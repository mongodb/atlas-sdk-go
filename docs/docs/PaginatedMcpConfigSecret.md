...
**Results** | [**[]ServiceAccountSecret**](ServiceAccountSecret.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedMcpConfigSecretWithDefaults
...
`func (o *PaginatedMcpConfigSecret) SetLinksNil()`
...
`func (o *PaginatedMcpConfigSecret) SetTotalCountNil()`
