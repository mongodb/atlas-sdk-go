...
**Results** | [**[]OrgGroup**](OrgGroup.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedOrgGroup(results []OrgGroup, ) *PaginatedOrgGroup`
