...
**Results** | [**[]AtlasOrganization**](AtlasOrganization.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedOrganization) SetLinksNil()`
...
`func (o *PaginatedOrganization) SetTotalCountNil()`
