...
**Results** | [**[]FederationIdentityProvider**](FederationIdentityProvider.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedFederationIdentityProvider(results []FederationIdentityProvider, ) *PaginatedFederationIdentityProvider`
...
`func (o *PaginatedFederationIdentityProvider) SetLinksNil()`
...
`func (o *PaginatedFederationIdentityProvider) SetTotalCountNil()`
