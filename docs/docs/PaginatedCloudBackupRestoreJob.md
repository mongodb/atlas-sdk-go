...
**Results** | [**[]DiskBackupSnapshotRestoreJob**](DiskBackupSnapshotRestoreJob.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedCloudBackupRestoreJob) SetLinksNil()`
...
`func (o *PaginatedCloudBackupRestoreJob) SetTotalCountNil()`
