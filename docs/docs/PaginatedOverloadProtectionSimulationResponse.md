...
**Results** | [**[]OverloadProtectionSimulationResponse**](OverloadProtectionSimulationResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedOverloadProtectionSimulationResponse
...
### NewPaginatedOverloadProtectionSimulationResponseWithDefaults
