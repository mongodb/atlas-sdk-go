...
**Results** | [**[]IngestionPipelineRun**](IngestionPipelineRun.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedPipelineRun(results []IngestionPipelineRun, ) *PaginatedPipelineRun`
