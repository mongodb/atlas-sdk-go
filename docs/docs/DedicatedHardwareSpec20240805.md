...
**DiskThroughput** | Pointer to **int** | Target throughput desired for storage attached to this hardware. Only returned for Gen 2 instance sizes with Standard (GP3) volume type. | [optional] [readonly] 
