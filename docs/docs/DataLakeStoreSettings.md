...
**Public** | Pointer to **bool** | Flag that indicates whether the blob store is public. If set to &#x60;true&#x60;, MongoDB Cloud doesn&#39;t use the configured Azure service principal to access the blob store. If set to &#x60;false&#x60;, the configured Azure service principal must include permissions to access the blob store. | [optional] [default to false]
