...
**Results** | [**[]DiskBackupShardedClusterSnapshot**](DiskBackupShardedClusterSnapshot.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedCloudBackupShardedClusterSnapshot(results []DiskBackupShardedClusterSnapshot, ) *PaginatedCloudBackupShardedClusterSnapshot`
...
`func (o *PaginatedCloudBackupShardedClusterSnapshot) SetLinksNil()`
...
`func (o *PaginatedCloudBackupShardedClusterSnapshot) SetTotalCountNil()`
