...
**Results** | [**[]EventViewForOrg**](EventViewForOrg.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewOrgPaginatedEvent(results []EventViewForOrg, ) *OrgPaginatedEvent`
...
`func (o *OrgPaginatedEvent) SetLinksNil()`
...
`func (o *OrgPaginatedEvent) SetTotalCountNil()`
