...
**Results** | [**[]StreamsPrivateLinkConnection**](StreamsPrivateLinkConnection.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiStreamsPrivateLink(results []StreamsPrivateLinkConnection, ) *PaginatedApiStreamsPrivateLink`
...
`func (o *PaginatedApiStreamsPrivateLink) SetLinksNil()`
...
`func (o *PaginatedApiStreamsPrivateLink) SetTotalCountNil()`
