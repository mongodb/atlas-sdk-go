...
**Results** | [**[]MeasurementDiskPartition**](MeasurementDiskPartition.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedDiskPartition(results []MeasurementDiskPartition, ) *PaginatedDiskPartition`
...
`func (o *PaginatedDiskPartition) SetLinksNil()`
