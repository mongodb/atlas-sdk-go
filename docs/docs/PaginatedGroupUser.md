...
**Results** | [**[]GroupUserResponse**](GroupUserResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedGroupUser(results []GroupUserResponse, ) *PaginatedGroupUser`
...
`func (o *PaginatedGroupUser) SetLinksNil()`
...
`func (o *PaginatedGroupUser) SetTotalCountNil()`
