...
**Results** | [**[]QueryShapeResponse**](QueryShapeResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedQueryShapes(results []QueryShapeResponse, ) *PaginatedQueryShapes`
...
`func (o *PaginatedQueryShapes) SetLinksNil()`
...
`func (o *PaginatedQueryShapes) SetTotalCountNil()`
