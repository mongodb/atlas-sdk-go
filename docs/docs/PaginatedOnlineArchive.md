...
**Results** | [**[]BackupOnlineArchive**](BackupOnlineArchive.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedOnlineArchive(results []BackupOnlineArchive, ) *PaginatedOnlineArchive`
...
`func (o *PaginatedOnlineArchive) SetLinksNil()`
...
`func (o *PaginatedOnlineArchive) SetTotalCountNil()`
