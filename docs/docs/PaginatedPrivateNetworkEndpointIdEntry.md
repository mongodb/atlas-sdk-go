...
**Results** | [**[]PrivateNetworkEndpointIdEntry**](PrivateNetworkEndpointIdEntry.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedPrivateNetworkEndpointIdEntry(results []PrivateNetworkEndpointIdEntry, ) *PaginatedPrivateNetworkEndpointIdEntry`
...
`func (o *PaginatedPrivateNetworkEndpointIdEntry) SetLinksNil()`
...
`func (o *PaginatedPrivateNetworkEndpointIdEntry) SetTotalCountNil()`
