...
SetGroupRoleNil sets GroupRole to an explicit JSON null when marshaled, overriding any value previously set with SetGroupRole. Calling SetGroupRole again clears the null override.
