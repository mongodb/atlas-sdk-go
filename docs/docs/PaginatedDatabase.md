...
**Results** | [**[]MesurementsDatabase**](MesurementsDatabase.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedDatabase(results []MesurementsDatabase, ) *PaginatedDatabase`
...
`func (o *PaginatedDatabase) SetLinksNil()`
...
`func (o *PaginatedDatabase) SetTotalCountNil()`
