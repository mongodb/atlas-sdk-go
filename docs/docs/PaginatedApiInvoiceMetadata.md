...
**Results** | [**[]BillingInvoiceMetadata**](BillingInvoiceMetadata.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedApiInvoiceMetadata) SetLinksNil()`
...
`func (o *PaginatedApiInvoiceMetadata) SetTotalCountNil()`
