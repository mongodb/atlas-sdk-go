...
**Results** | [**[]ApiAtlasCheckpoint**](ApiAtlasCheckpoint.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiAtlasCheckpoint(results []ApiAtlasCheckpoint, ) *PaginatedApiAtlasCheckpoint`
...
`func (o *PaginatedApiAtlasCheckpoint) SetLinksNil()`
...
`func (o *PaginatedApiAtlasCheckpoint) SetTotalCountNil()`
