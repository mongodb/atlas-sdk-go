...
**Results** | [**[]TeamRole**](TeamRole.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedTeamRole) SetLinksNil()`
...
`func (o *PaginatedTeamRole) SetTotalCountNil()`
