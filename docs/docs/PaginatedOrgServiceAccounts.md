...
**Results** | [**[]OrgServiceAccount**](OrgServiceAccount.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedOrgServiceAccounts(results []OrgServiceAccount, ) *PaginatedOrgServiceAccounts`
...
`func (o *PaginatedOrgServiceAccounts) SetLinksNil()`
...
`func (o *PaginatedOrgServiceAccounts) SetTotalCountNil()`
