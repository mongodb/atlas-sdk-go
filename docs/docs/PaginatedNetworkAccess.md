...
**Results** | [**[]NetworkPermissionEntry**](NetworkPermissionEntry.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedNetworkAccess(results []NetworkPermissionEntry, ) *PaginatedNetworkAccess`
...
`func (o *PaginatedNetworkAccess) SetLinksNil()`
