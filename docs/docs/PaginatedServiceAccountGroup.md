...
**Results** | [**[]ServiceAccountGroup**](ServiceAccountGroup.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedServiceAccountGroup) SetLinksNil()`
...
`func (o *PaginatedServiceAccountGroup) SetTotalCountNil()`
