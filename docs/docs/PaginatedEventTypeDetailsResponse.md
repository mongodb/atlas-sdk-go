...
**Results** | [**[]EventTypeDetails**](EventTypeDetails.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedEventTypeDetailsResponse(results []EventTypeDetails, ) *PaginatedEventTypeDetailsResponse`
...
`func (o *PaginatedEventTypeDetailsResponse) SetLinksNil()`
...
`func (o *PaginatedEventTypeDetailsResponse) SetTotalCountNil()`
