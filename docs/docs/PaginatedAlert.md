...
**Results** | [**[]AlertViewForNdsGroup**](AlertViewForNdsGroup.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedAlert(results []AlertViewForNdsGroup, ) *PaginatedAlert`
...
`func (o *PaginatedAlert) SetLinksNil()`
...
`func (o *PaginatedAlert) SetTotalCountNil()`
