...
**Results** | [**[]Group**](Group.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedAtlasGroup) SetLinksNil()`
...
`func (o *PaginatedAtlasGroup) SetTotalCountNil()`
