...
**Results** | [**[]LogIntegrationResponse**](LogIntegrationResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedLogIntegrationResponse
...
### NewPaginatedLogIntegrationResponseWithDefaults
...
`func (o *PaginatedLogIntegrationResponse) SetLinksNil()`
...
`func (o *PaginatedLogIntegrationResponse) SetTotalCountNil()`
