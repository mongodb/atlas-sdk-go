...
**Results** | Pointer to [**[]LogIntegrationResponse**](LogIntegrationResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [optional] [readonly] 
...
`func NewPaginatedLogIntegrationResponse() *PaginatedLogIntegrationResponse`
...
`func (o *PaginatedLogIntegrationResponse) HasResults() bool`
