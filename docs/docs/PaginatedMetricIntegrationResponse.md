...
**Results** | [**[]MetricIntegrationResponse**](MetricIntegrationResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedMetricIntegrationResponse
...
### NewPaginatedMetricIntegrationResponseWithDefaults
...
`func (o *PaginatedMetricIntegrationResponse) SetLinksNil()`
...
`func (o *PaginatedMetricIntegrationResponse) SetTotalCountNil()`
