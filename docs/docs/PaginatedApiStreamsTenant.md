...
**Results** | [**[]StreamsTenant**](StreamsTenant.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiStreamsTenant(results []StreamsTenant, ) *PaginatedApiStreamsTenant`
...
`func (o *PaginatedApiStreamsTenant) SetLinksNil()`
...
`func (o *PaginatedApiStreamsTenant) SetTotalCountNil()`
