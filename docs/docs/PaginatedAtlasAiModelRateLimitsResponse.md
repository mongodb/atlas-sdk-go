...
**Results** | [**[]AiModelRateLimitResponse**](AiModelRateLimitResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedAtlasAiModelRateLimitsResponse
...
### NewPaginatedAtlasAiModelRateLimitsResponseWithDefaults
