...
**Results** | [**[]GroupAlertsConfig**](GroupAlertsConfig.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedAlertConfig(results []GroupAlertsConfig, ) *PaginatedAlertConfig`
...
`func (o *PaginatedAlertConfig) SetLinksNil()`
...
`func (o *PaginatedAlertConfig) SetTotalCountNil()`
