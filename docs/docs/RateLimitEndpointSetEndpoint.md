...
------------ | ------------- | ------------- | -------------
**Method** | Pointer to **string** | The HTTP method of the endpoint. | [optional] 
**Path** | Pointer to **string** | The URL path of the endpoint. | [optional] 

## Methods

### NewRateLimitEndpointSetEndpoint
...
### NewRateLimitEndpointSetEndpointWithDefaults
