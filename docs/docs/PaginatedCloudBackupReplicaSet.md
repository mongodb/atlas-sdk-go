...
**Results** | [**[]DiskBackupReplicaSet**](DiskBackupReplicaSet.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedCloudBackupReplicaSet(results []DiskBackupReplicaSet, ) *PaginatedCloudBackupReplicaSet`
...
`func (o *PaginatedCloudBackupReplicaSet) SetLinksNil()`
...
`func (o *PaginatedCloudBackupReplicaSet) SetTotalCountNil()`
