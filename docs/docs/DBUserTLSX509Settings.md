...
SetCasNil sets Cas to an explicit JSON null when marshaled, overriding any value previously set with SetCas. Calling SetCas again clears the null override.
