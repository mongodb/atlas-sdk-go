...
**FeatureCompatibilityVersionExpirationDate** | Pointer to **time.Time** | Feature compatibility version expiration date. Will only appear if FCV is pinned. | [optional] [readonly] 
