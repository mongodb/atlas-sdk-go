...
**Results** | [**[]CloudProviderRegions**](CloudProviderRegions.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiAtlasProviderRegions(results []CloudProviderRegions, ) *PaginatedApiAtlasProviderRegions`
...
`func (o *PaginatedApiAtlasProviderRegions) SetLinksNil()`
...
`func (o *PaginatedApiAtlasProviderRegions) SetTotalCountNil()`
