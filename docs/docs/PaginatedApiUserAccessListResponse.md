...
**Results** | [**[]UserAccessListResponse**](UserAccessListResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedApiUserAccessListResponse) SetLinksNil()`
...
`func (o *PaginatedApiUserAccessListResponse) SetTotalCountNil()`
