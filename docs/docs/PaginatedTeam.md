...
**Results** | [**[]TeamResponse**](TeamResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedTeam(results []TeamResponse, ) *PaginatedTeam`
...
`func (o *PaginatedTeam) SetLinksNil()`
...
`func (o *PaginatedTeam) SetTotalCountNil()`
