...
**Results** | [**[]EARPrivateEndpoint**](EARPrivateEndpoint.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiAtlasEARPrivateEndpoint(results []EARPrivateEndpoint, ) *PaginatedApiAtlasEARPrivateEndpoint`
...
`func (o *PaginatedApiAtlasEARPrivateEndpoint) SetLinksNil()`
...
`func (o *PaginatedApiAtlasEARPrivateEndpoint) SetTotalCountNil()`
