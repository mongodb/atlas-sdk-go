...
**Results** | [**[]BillingInvoice**](BillingInvoice.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedApiInvoice) SetLinksNil()`
...
`func (o *PaginatedApiInvoice) SetTotalCountNil()`
