...
**Results** | [**[]PublicApiUsageDetailsLineItem**](PublicApiUsageDetailsLineItem.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedPublicApiUsageDetailsLineItem(results []PublicApiUsageDetailsLineItem, ) *PaginatedPublicApiUsageDetailsLineItem`
...
`func (o *PaginatedPublicApiUsageDetailsLineItem) SetLinksNil()`
...
`func (o *PaginatedPublicApiUsageDetailsLineItem) SetTotalCountNil()`
