...
**Results** | [**[]UserCert**](UserCert.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedUserCert) SetLinksNil()`
...
`func (o *PaginatedUserCert) SetTotalCountNil()`
