...
**Results** | [**[]DiskBackupSnapshotExportBucketResponse**](DiskBackupSnapshotExportBucketResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedBackupSnapshotExportBuckets(results []DiskBackupSnapshotExportBucketResponse, ) *PaginatedBackupSnapshotExportBuckets`
...
`func (o *PaginatedBackupSnapshotExportBuckets) SetLinksNil()`
...
`func (o *PaginatedBackupSnapshotExportBuckets) SetTotalCountNil()`
