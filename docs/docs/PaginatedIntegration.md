...
**Results** | [**[]ThirdPartyIntegration**](ThirdPartyIntegration.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedIntegration) SetLinksNil()`
...
`func (o *PaginatedIntegration) SetTotalCountNil()`
