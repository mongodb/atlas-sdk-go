...
`func (o *EventViewForOrg) GetDelegatePrincipal() Principal`

GetDelegatePrincipal returns the DelegatePrincipal field if non-nil, zero value otherwise.

### GetDelegatePrincipalOk

`func (o *EventViewForOrg) GetDelegatePrincipalOk() (*Principal, bool)`
