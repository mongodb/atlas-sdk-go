...
**Results** | [**[]ServiceAccountIPAccessListEntry**](ServiceAccountIPAccessListEntry.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedServiceAccountIPAccessEntry) SetLinksNil()`
...
`func (o *PaginatedServiceAccountIPAccessEntry) SetTotalCountNil()`
