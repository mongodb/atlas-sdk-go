...
**Results** | [**[]GroupServiceAccount**](GroupServiceAccount.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedGroupServiceAccounts(results []GroupServiceAccount, ) *PaginatedGroupServiceAccounts`
...
`func (o *PaginatedGroupServiceAccounts) SetLinksNil()`
...
`func (o *PaginatedGroupServiceAccounts) SetTotalCountNil()`
