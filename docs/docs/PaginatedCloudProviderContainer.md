...
**Results** | [**[]CloudProviderContainer**](CloudProviderContainer.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedCloudProviderContainer(results []CloudProviderContainer, ) *PaginatedCloudProviderContainer`
...
`func (o *PaginatedCloudProviderContainer) SetLinksNil()`
...
`func (o *PaginatedCloudProviderContainer) SetTotalCountNil()`
