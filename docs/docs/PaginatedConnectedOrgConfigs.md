...
**Results** | [**[]ConnectedOrgConfig**](ConnectedOrgConfig.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedConnectedOrgConfigs(results []ConnectedOrgConfig, ) *PaginatedConnectedOrgConfigs`
