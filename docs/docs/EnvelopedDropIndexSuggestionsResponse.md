...
------------ | ------------- | ------------- | -------------
**Content** | [**DropIndexSuggestionsResponse**](DropIndexSuggestionsResponse.md) |  | 
...
### NewEnvelopedDropIndexSuggestionsResponse
...
### NewEnvelopedDropIndexSuggestionsResponseWithDefaults
