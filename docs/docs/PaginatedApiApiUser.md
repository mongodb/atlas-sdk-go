...
**Results** | Pointer to [**[]ApiKeyUser**](ApiKeyUser.md) | List of returned documents that MongoDB Cloud providers when completing this request. | [optional] [readonly] 
...
`func (o *PaginatedApiApiUser) GetResults() []ApiKeyUser`

GetResults returns the Results field if non-nil, zero value otherwise.

### GetResultsOk

`func (o *PaginatedApiApiUser) GetResultsOk() (*[]ApiKeyUser, bool)`
...
`func (o *PaginatedApiApiUser) SetResults(v []ApiKeyUser)`
