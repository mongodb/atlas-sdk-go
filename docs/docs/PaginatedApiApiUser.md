...
**Results** | [**[]ApiKeyUserDetails**](ApiKeyUserDetails.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedApiApiUser) SetLinksNil()`
...
`func (o *PaginatedApiApiUser) SetTotalCountNil()`
