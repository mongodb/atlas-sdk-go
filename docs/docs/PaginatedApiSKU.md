...
**Results** | [**[]SkuResponse**](SkuResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedApiSKUWithDefaults
...
`func (o *PaginatedApiSKU) SetLinksNil()`
...
`func (o *PaginatedApiSKU) SetTotalCountNil()`
