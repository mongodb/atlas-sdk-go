...
**Results** | Pointer to [**[]SkuResponse**](SkuResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [optional] [readonly] 
...
`func NewPaginatedApiSKU() *PaginatedApiSKU`
...
`func (o *PaginatedApiSKU) HasResults() bool`
