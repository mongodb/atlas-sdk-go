...
**Results** | [**[]DiskBackupExportJob**](DiskBackupExportJob.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedApiAtlasDiskBackupExportJob(results []DiskBackupExportJob, ) *PaginatedApiAtlasDiskBackupExportJob`
...
`func (o *PaginatedApiAtlasDiskBackupExportJob) SetLinksNil()`
...
`func (o *PaginatedApiAtlasDiskBackupExportJob) SetTotalCountNil()`
