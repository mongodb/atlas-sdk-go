...
**Results** | [**[]CloudAppUser**](CloudAppUser.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedApiAppUser) SetLinksNil()`
...
`func (o *PaginatedApiAppUser) SetTotalCountNil()`
