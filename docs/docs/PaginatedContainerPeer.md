...
**Results** | [**[]BaseNetworkPeeringConnectionSettings**](BaseNetworkPeeringConnectionSettings.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedContainerPeer) SetLinksNil()`
...
`func (o *PaginatedContainerPeer) SetTotalCountNil()`
