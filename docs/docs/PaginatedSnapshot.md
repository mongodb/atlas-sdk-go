...
**Results** | [**[]BackupSnapshot**](BackupSnapshot.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func (o *PaginatedSnapshot) SetLinksNil()`
...
`func (o *PaginatedSnapshot) SetTotalCountNil()`
