...
**Results** | [**[]OrgUserResponse**](OrgUserResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
`func NewPaginatedOrgUser(results []OrgUserResponse, ) *PaginatedOrgUser`
...
`func (o *PaginatedOrgUser) SetLinksNil()`
...
`func (o *PaginatedOrgUser) SetTotalCountNil()`
