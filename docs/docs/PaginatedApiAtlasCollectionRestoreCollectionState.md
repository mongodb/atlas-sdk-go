# PaginatedApiAtlasCollectionRestoreCollectionState
...
**Results** | [**[]ApiAtlasCollectionRestoreCollectionStateResponse**](ApiAtlasCollectionRestoreCollectionStateResponse.md) | List of returned documents that MongoDB Cloud provides when completing this request. | [readonly] 
...
### NewPaginatedApiAtlasCollectionRestoreCollectionState
...
### NewPaginatedApiAtlasCollectionRestoreCollectionStateWithDefaults
...
`func (o *PaginatedApiAtlasCollectionRestoreCollectionState) SetLinksNil()`
...
`func (o *PaginatedApiAtlasCollectionRestoreCollectionState) SetTotalCountNil()`
