...
func (_m *NetworkPeeringApi) DeletePeeringConnectionExecute(r admin.DeletePeeringConnectionApiRequest) (map[string]any, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.DeletePeeringConnectionApiRequest) (map[string]any, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.DeletePeeringConnectionApiRequest) map[string]any); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
...
func (_c *NetworkPeeringApi_DeletePeeringConnectionExecute_Call) Return(_a0 map[string]any, _a1 *http.Response, _a2 error) *NetworkPeeringApi_DeletePeeringConnectionExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *NetworkPeeringApi_DeletePeeringConnectionExecute_Call) RunAndReturn(run func(admin.DeletePeeringConnectionApiRequest) (map[string]any, *http.Response, error)) *NetworkPeeringApi_DeletePeeringConnectionExecute_Call {
	_c.Call.Return(run)
	return _c
}
