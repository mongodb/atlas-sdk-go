...
// ListSuggestedIndexes1 provides a mock function with given fields: ctx, groupId, clusterName
func (_m *PerformanceAdvisorApi) ListSuggestedIndexes1(ctx context.Context, groupId string, clusterName string) admin.ListSuggestedIndexes1ApiRequest {
	ret := _m.Called(ctx, groupId, clusterName)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string) admin.ListSuggestedIndexes1ApiRequest); ok {
		r0 = rf(ctx, groupId, clusterName)
	} else {
...
//   - groupId string
//   - clusterName string
func (_e *PerformanceAdvisorApi_Expecter) ListSuggestedIndexes1(ctx interface{}, groupId interface{}, clusterName interface{}) *PerformanceAdvisorApi_ListSuggestedIndexes1_Call {
	return &PerformanceAdvisorApi_ListSuggestedIndexes1_Call{Call: _e.mock.On("ListSuggestedIndexes1", ctx, groupId, clusterName)}
}

func (_c *PerformanceAdvisorApi_ListSuggestedIndexes1_Call) Run(run func(ctx context.Context, groupId string, clusterName string)) *PerformanceAdvisorApi_ListSuggestedIndexes1_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string))
	})
	return _c
...
func (_c *PerformanceAdvisorApi_ListSuggestedIndexes1_Call) RunAndReturn(run func(context.Context, string, string) admin.ListSuggestedIndexes1ApiRequest) *PerformanceAdvisorApi_ListSuggestedIndexes1_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *PerformanceAdvisorApi_Expecter) ListSuggestedIndexes1Execute(r interface{}) *PerformanceAdvisorApi_ListSuggestedIndexes1Execute_Call {
...
func (_e *PerformanceAdvisorApi_Expecter) ListSuggestedIndexes1WithParams(ctx interface{}, args interface{}) *PerformanceAdvisorApi_ListSuggestedIndexes1WithParams_Call {
