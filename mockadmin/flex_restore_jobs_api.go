...
// CreateFlexBackupRestoreJob provides a mock function with given fields: ctx, groupId, name, flexBackupRestoreJobCreate20250101
func (_m *FlexRestoreJobsApi) CreateFlexBackupRestoreJob(ctx context.Context, groupId string, name string, flexBackupRestoreJobCreate20250101 *admin.FlexBackupRestoreJobCreate20250101) admin.CreateFlexBackupRestoreJobApiRequest {
	ret := _m.Called(ctx, groupId, name, flexBackupRestoreJobCreate20250101)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *admin.FlexBackupRestoreJobCreate20250101) admin.CreateFlexBackupRestoreJobApiRequest); ok {
		r0 = rf(ctx, groupId, name, flexBackupRestoreJobCreate20250101)
	} else {
...
//   - groupId string
//   - name string
//   - flexBackupRestoreJobCreate20250101 *admin.FlexBackupRestoreJobCreate20250101
func (_e *FlexRestoreJobsApi_Expecter) CreateFlexBackupRestoreJob(ctx any, groupId any, name any, flexBackupRestoreJobCreate20250101 any) *FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call {
	return &FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call{Call: _e.mock.On("CreateFlexBackupRestoreJob", ctx, groupId, name, flexBackupRestoreJobCreate20250101)}
}

func (_c *FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call) Run(run func(ctx context.Context, groupId string, name string, flexBackupRestoreJobCreate20250101 *admin.FlexBackupRestoreJobCreate20250101)) *FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(*admin.FlexBackupRestoreJobCreate20250101))
	})
	return _c
}
...
func (_c *FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call) RunAndReturn(run func(context.Context, string, string, *admin.FlexBackupRestoreJobCreate20250101) admin.CreateFlexBackupRestoreJobApiRequest) *FlexRestoreJobsApi_CreateFlexBackupRestoreJob_Call {
	_c.Call.Return(run)
	return _c
}

// CreateFlexBackupRestoreJobExecute provides a mock function with given fields: r
func (_m *FlexRestoreJobsApi) CreateFlexBackupRestoreJobExecute(r admin.CreateFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r0 *admin.FlexBackupRestoreJob20250101
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.CreateFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.CreateFlexBackupRestoreJobApiRequest) *admin.FlexBackupRestoreJob20250101); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*admin.FlexBackupRestoreJob20250101)
		}
	}
...
func (_c *FlexRestoreJobsApi_CreateFlexBackupRestoreJobExecute_Call) Return(_a0 *admin.FlexBackupRestoreJob20250101, _a1 *http.Response, _a2 error) *FlexRestoreJobsApi_CreateFlexBackupRestoreJobExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *FlexRestoreJobsApi_CreateFlexBackupRestoreJobExecute_Call) RunAndReturn(run func(admin.CreateFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)) *FlexRestoreJobsApi_CreateFlexBackupRestoreJobExecute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *FlexRestoreJobsApi) GetFlexBackupRestoreJobExecute(r admin.GetFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.GetFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.GetFlexBackupRestoreJobApiRequest) *admin.FlexBackupRestoreJob20250101); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*admin.FlexBackupRestoreJob20250101)
...
func (_c *FlexRestoreJobsApi_GetFlexBackupRestoreJobExecute_Call) Return(_a0 *admin.FlexBackupRestoreJob20250101, _a1 *http.Response, _a2 error) *FlexRestoreJobsApi_GetFlexBackupRestoreJobExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *FlexRestoreJobsApi_GetFlexBackupRestoreJobExecute_Call) RunAndReturn(run func(admin.GetFlexBackupRestoreJobApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)) *FlexRestoreJobsApi_GetFlexBackupRestoreJobExecute_Call {
	_c.Call.Return(run)
	return _c
}
