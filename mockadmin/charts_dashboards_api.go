...
// ImportChartsDashboard provides a mock function with given fields: ctx, groupId, body
func (_m *ChartsDashboardsApi) ImportChartsDashboard(ctx context.Context, groupId string, body *any) admin.ImportChartsDashboardApiRequest {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, *any) admin.ImportChartsDashboardApiRequest); ok {
...
//   - groupId string
//   - body *any
func (_e *ChartsDashboardsApi_Expecter) ImportChartsDashboard(ctx any, groupId any, body any) *ChartsDashboardsApi_ImportChartsDashboard_Call {
	return &ChartsDashboardsApi_ImportChartsDashboard_Call{Call: _e.mock.On("ImportChartsDashboard", ctx, groupId, body)}
}

func (_c *ChartsDashboardsApi_ImportChartsDashboard_Call) Run(run func(ctx context.Context, groupId string, body *any)) *ChartsDashboardsApi_ImportChartsDashboard_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ChartsDashboardsApi_ImportChartsDashboard_Call) RunAndReturn(run func(context.Context, string, *any) admin.ImportChartsDashboardApiRequest) *ChartsDashboardsApi_ImportChartsDashboard_Call {
	_c.Call.Return(run)
	return _c
}
