...
// RequestEncryptionAtRestPrivateEndpointDeletion provides a mock function with given fields: ctx, groupId, cloudProvider, endpointId, encryptionAtRestPrivateEndpointRequest
func (_m *EncryptionAtRestUsingCustomerKeyManagementApi) RequestEncryptionAtRestPrivateEndpointDeletion(ctx context.Context, groupId string, cloudProvider string, endpointId string, encryptionAtRestPrivateEndpointRequest *admin.EncryptionAtRestPrivateEndpointRequest) admin.RequestEncryptionAtRestPrivateEndpointDeletionApiRequest {
	ret := _m.Called(ctx, groupId, cloudProvider, endpointId, encryptionAtRestPrivateEndpointRequest)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, *admin.EncryptionAtRestPrivateEndpointRequest) admin.RequestEncryptionAtRestPrivateEndpointDeletionApiRequest); ok {
		r0 = rf(ctx, groupId, cloudProvider, endpointId, encryptionAtRestPrivateEndpointRequest)
	} else {
...
//   - cloudProvider string
//   - endpointId string
//   - encryptionAtRestPrivateEndpointRequest *admin.EncryptionAtRestPrivateEndpointRequest
func (_e *EncryptionAtRestUsingCustomerKeyManagementApi_Expecter) RequestEncryptionAtRestPrivateEndpointDeletion(ctx interface{}, groupId interface{}, cloudProvider interface{}, endpointId interface{}, encryptionAtRestPrivateEndpointRequest interface{}) *EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call {
	return &EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call{Call: _e.mock.On("RequestEncryptionAtRestPrivateEndpointDeletion", ctx, groupId, cloudProvider, endpointId, encryptionAtRestPrivateEndpointRequest)}
}

func (_c *EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call) Run(run func(ctx context.Context, groupId string, cloudProvider string, endpointId string, encryptionAtRestPrivateEndpointRequest *admin.EncryptionAtRestPrivateEndpointRequest)) *EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(string), args[4].(*admin.EncryptionAtRestPrivateEndpointRequest))
	})
	return _c
}
...
func (_c *EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call) RunAndReturn(run func(context.Context, string, string, string, *admin.EncryptionAtRestPrivateEndpointRequest) admin.RequestEncryptionAtRestPrivateEndpointDeletionApiRequest) *EncryptionAtRestUsingCustomerKeyManagementApi_RequestEncryptionAtRestPrivateEndpointDeletion_Call {
	_c.Call.Return(run)
	return _c
}
