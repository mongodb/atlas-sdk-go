...
// CreateExportBucket provides a mock function with given fields: ctx, groupId, diskBackupSnapshotAWSExportBucketRequest
func (_m *CloudBackupsApi) CreateExportBucket(ctx context.Context, groupId string, diskBackupSnapshotAWSExportBucketRequest *admin.DiskBackupSnapshotAWSExportBucketRequest) admin.CreateExportBucketApiRequest {
	ret := _m.Called(ctx, groupId, diskBackupSnapshotAWSExportBucketRequest)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, *admin.DiskBackupSnapshotAWSExportBucketRequest) admin.CreateExportBucketApiRequest); ok {
		r0 = rf(ctx, groupId, diskBackupSnapshotAWSExportBucketRequest)
	} else {
...
//   - ctx context.Context
//   - groupId string
//   - diskBackupSnapshotAWSExportBucketRequest *admin.DiskBackupSnapshotAWSExportBucketRequest
func (_e *CloudBackupsApi_Expecter) CreateExportBucket(ctx any, groupId any, diskBackupSnapshotAWSExportBucketRequest any) *CloudBackupsApi_CreateExportBucket_Call {
	return &CloudBackupsApi_CreateExportBucket_Call{Call: _e.mock.On("CreateExportBucket", ctx, groupId, diskBackupSnapshotAWSExportBucketRequest)}
}

func (_c *CloudBackupsApi_CreateExportBucket_Call) Run(run func(ctx context.Context, groupId string, diskBackupSnapshotAWSExportBucketRequest *admin.DiskBackupSnapshotAWSExportBucketRequest)) *CloudBackupsApi_CreateExportBucket_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*admin.DiskBackupSnapshotAWSExportBucketRequest))
	})
	return _c
}
...
func (_c *CloudBackupsApi_CreateExportBucket_Call) RunAndReturn(run func(context.Context, string, *admin.DiskBackupSnapshotAWSExportBucketRequest) admin.CreateExportBucketApiRequest) *CloudBackupsApi_CreateExportBucket_Call {
	_c.Call.Return(run)
	return _c
}

// CreateExportBucketExecute provides a mock function with given fields: r
func (_m *CloudBackupsApi) CreateExportBucketExecute(r admin.CreateExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.CreateExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.CreateExportBucketApiRequest) *admin.DiskBackupSnapshotAWSExportBucketResponse); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
...
func (_c *CloudBackupsApi_CreateExportBucketExecute_Call) Return(_a0 *admin.DiskBackupSnapshotAWSExportBucketResponse, _a1 *http.Response, _a2 error) *CloudBackupsApi_CreateExportBucketExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *CloudBackupsApi_CreateExportBucketExecute_Call) RunAndReturn(run func(admin.CreateExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error)) *CloudBackupsApi_CreateExportBucketExecute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloudBackupsApi) GetExportBucketExecute(r admin.GetExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.GetExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.GetExportBucketApiRequest) *admin.DiskBackupSnapshotAWSExportBucketResponse); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*admin.DiskBackupSnapshotAWSExportBucketResponse)
...
func (_c *CloudBackupsApi_GetExportBucketExecute_Call) Return(_a0 *admin.DiskBackupSnapshotAWSExportBucketResponse, _a1 *http.Response, _a2 error) *CloudBackupsApi_GetExportBucketExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *CloudBackupsApi_GetExportBucketExecute_Call) RunAndReturn(run func(admin.GetExportBucketApiRequest) (*admin.DiskBackupSnapshotAWSExportBucketResponse, *http.Response, error)) *CloudBackupsApi_GetExportBucketExecute_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *CloudBackupsApi_Expecter) UpdateBackupSchedule(ctx any, groupId any, clusterName any, diskBackupSnapshotSchedule any) *CloudBackupsApi_UpdateBackupSchedule_Call {
