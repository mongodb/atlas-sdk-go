...
func (_m *FlexSnapshotsApi) DownloadFlexBackupExecute(r admin.DownloadFlexBackupApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error) {
	ret := _m.Called(r)
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(admin.DownloadFlexBackupApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(admin.DownloadFlexBackupApiRequest) *admin.FlexBackupRestoreJob20250101); ok {
		r0 = rf(r)
	} else {
		if ret.Get(0) != nil {
...
func (_c *FlexSnapshotsApi_DownloadFlexBackupExecute_Call) Return(_a0 *admin.FlexBackupRestoreJob20250101, _a1 *http.Response, _a2 error) *FlexSnapshotsApi_DownloadFlexBackupExecute_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *FlexSnapshotsApi_DownloadFlexBackupExecute_Call) RunAndReturn(run func(admin.DownloadFlexBackupApiRequest) (*admin.FlexBackupRestoreJob20250101, *http.Response, error)) *FlexSnapshotsApi_DownloadFlexBackupExecute_Call {
	_c.Call.Return(run)
	return _c
}
